...
bool CBonusMapsDatabase::SetBooleanStatus(const char *pchName, const char *pchFileName, const char *pchMapName,
                                          bool bValue) {
    bool bChanged = ::SetBooleanStatus(m_pBonusMapSavedData->FindKey("bonusfiles", true), pchName, pchFileName,
                                       pchMapName, bValue);
    if (bChanged)
        m_bSavedDataChanged = true;
...
bool
CBonusMapsDatabase::UpdateChallengeBest(const char *pchFileName, const char *pchMapName, const char *pchChallengeName,
                                        int iBest) {
