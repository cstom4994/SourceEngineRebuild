...
CrosshairImagePanelSimple::CrosshairImagePanelSimple(Panel *parent, const char *name,
                                                     COptionsSubMultiplayer *pOptionsPanel) : CrosshairImagePanelBase(
        parent, name) {
...
CrosshairImagePanelCS::CrosshairImagePanelCS(Panel *parent, const char *name, COptionsSubMultiplayer *pOptionsPanel)
    ...
    m_pDotCheckbox = new CCvarToggleCheckButton(m_pOptionsPanel, "CrosshairDotCheckbox", "#GameUI_CrosshairDot",
                                                "cl_crosshairdot");
...
//-----------------------------------------------------------------------------
COptionsSubMultiplayer::COptionsSubMultiplayer(vgui::Panel *parent) : vgui::PropertyPage(parent,
    ...
    m_pHighQualityModelCheckBox = new CCvarToggleCheckButton(this, "High Quality Models", "#GameUI_HighModels",
                                                             "cl_himodels");
    ...
    m_pLockRadarRotationCheckbox = new CCvarToggleCheckButton(this, "LockRadarRotationCheckbox", "#Cstrike_RadarLocked",
                                                              "cl_radar_locked");
...
void COptionsSubMultiplayer::OnFileSelected(const char *fullpath) {
    ...
    ConversionErrorType nErrorCode = ImgUtl_ConvertToVTFAndDumpVMT(fullpath,
                                                                   IsPosix() ? "/vgui/logos" : "\\vgui\\logos", 256,
                                                                   256);
