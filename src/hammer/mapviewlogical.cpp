...
static color32 s_pBrokenWireColor[LOGICAL_CONN_SELECTION_STATES] =
        {
                {DARK,  0, 0, 255},            /* Dark Red */
                {BRITE, 0, 0, 255},            /* Bright Red */
        };
...
const color32 &
CMapViewLogical::GetWireColor(const char *pszName, const bool bSelected, const bool bError, const bool bAnySelected) {
