...
//-----------------------------------------------------------------------------
void
CMapAnimator::GetAnimationAtTime(CMapKeyFrame *currentKey, CMapKeyFrame *pPrevKey, float partialTime, Vector &newOrigin,
...
void CMapAnimator::UpdateAnimation(float animTime) {
    ...
    QuaternionMatrix(newAngles, (matrix3x4_t&)mat.As3x4());
