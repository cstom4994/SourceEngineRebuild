...
void CDispShoreManager::BuildShorelineOverlayPoint(Shoreline_t *pShoreline, int iSegment,
    ...
    // Water points.
    pShoreline->m_aSegments[iSegment].m_WaterFace.m_vecPoints[0] = pShoreline->m_aSegments[iSegment].m_vecPoints[0] +
    ...
    pShoreline->m_aSegments[iSegment].m_WaterFace.m_vecPoints[3] = pShoreline->m_aSegments[iSegment].m_vecPoints[1] +
    ...
    pShoreline->m_aSegments[iSegment].m_vecCenter =
            (pShoreline->m_aSegments[iSegment].m_vecPoints[0] + pShoreline->m_aSegments[iSegment].m_vecPoints[1]) *
            0.5f;
    ...
    while (iSegment != -1) {
        ...
        for (iSegment2 = 0; iSegment2 < nSegmentCount; ++iSegment2) {
            ...
            if (VectorsAreEqual(pShoreline->m_aSegments[iSegment].m_vecPoints[0],
                                ...
                                DISPSHORE_VECTOR_EPS)) { bIsTouching0 = true; }
            ...
            if (VectorsAreEqual(pShoreline->m_aSegments[iSegment].m_vecPoints[0],
                                ...
                                DISPSHORE_VECTOR_EPS)) { bIsTouching1 = true; }
            if (VectorsAreEqual(pShoreline->m_aSegments[iSegment].m_vecPoints[1],
                                pShoreline->m_aSegments[iSegment2].m_vecPoints[1],
                                DISPSHORE_VECTOR_EPS)) { bIsTouching1 = true; }
