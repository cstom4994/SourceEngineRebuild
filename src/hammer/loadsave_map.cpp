...
int CMapFace::SerializeMAP(std::fstream &file, BOOL fIsStoring) {
    ...
    if (fIsStoring) {
        ...
        sprintf(szBuf,
                ...
                (double) texture.UAxis[0], (double) texture.UAxis[1], (double) texture.UAxis[2],
                (double) texture.UAxis[3],
                (double) texture.VAxis[0], (double) texture.VAxis[1], (double) texture.VAxis[2],
                (double) texture.VAxis[3],
