...
//----------------------------------------------------------------------------
    void CopyProtoBufField(::google::protobuf::Message &msgDest, const ::google::protobuf::Message &msgSource,
        ...
        if (pFieldDest->is_repeated()) {
            ...
            switch (pFieldDest->cpp_type()) {
                case ::google::protobuf::FieldDescriptor::CPPTYPE_INT32: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddInt32(&msgDest, pFieldDest,
                                                              msgSource.GetReflection()->GetRepeatedInt32(msgSource,
                                                                                                          pFieldSource,
                                                                                                          i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedInt32(&msgDest, pFieldDest, i,
                                                                      msgSource.GetReflection()->GetRepeatedInt32(
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_INT64: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddInt64(&msgDest, pFieldDest,
                                                              msgSource.GetReflection()->GetRepeatedInt64(msgSource,
                                                                                                          pFieldSource,
                                                                                                          i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedInt64(&msgDest, pFieldDest, i,
                                                                      msgSource.GetReflection()->GetRepeatedInt64(
                                                                              msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_UINT32: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddUInt32(&msgDest, pFieldDest,
                                                               msgSource.GetReflection()->GetRepeatedUInt32(msgSource,
                                                                                                            pFieldSource,
                                                                                                            i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedUInt32(&msgDest, pFieldDest, i,
                                                                       msgSource.GetReflection()->GetRepeatedUInt32(
                                                                               msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_UINT64: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddUInt64(&msgDest, pFieldDest,
                                                               msgSource.GetReflection()->GetRepeatedUInt64(msgSource,
                                                                                                            pFieldSource,
                                                                                                            i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedUInt64(&msgDest, pFieldDest, i,
                                                                       msgSource.GetReflection()->GetRepeatedUInt64(
                                                                               msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddDouble(&msgDest, pFieldDest,
                                                               msgSource.GetReflection()->GetRepeatedDouble(msgSource,
                                                                                                            pFieldSource,
                                                                                                            i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedDouble(&msgDest, pFieldDest, i,
                                                                       msgSource.GetReflection()->GetRepeatedDouble(
                                                                               msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_FLOAT: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddFloat(&msgDest, pFieldDest,
                                                              msgSource.GetReflection()->GetRepeatedFloat(msgSource,
                                                                                                          pFieldSource,
                                                                                                          i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedFloat(&msgDest, pFieldDest, i,
                                                                      msgSource.GetReflection()->GetRepeatedFloat(
                                                                              msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_BOOL: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddBool(&msgDest, pFieldDest,
                                                             msgSource.GetReflection()->GetRepeatedBool(msgSource,
                                                                                                        pFieldSource,
                                                                                                        i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedBool(&msgDest, pFieldDest, i,
                                                                     msgSource.GetReflection()->GetRepeatedBool(
                                                                             msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddEnum(&msgDest, pFieldDest,
                                                             msgSource.GetReflection()->GetRepeatedEnum(msgSource,
                                                                                                        pFieldSource,
                                                                                                        i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedEnum(&msgDest, pFieldDest, i,
                                                                     msgSource.GetReflection()->GetRepeatedEnum(
                                                                             msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddString(&msgDest, pFieldDest,
                                                               msgSource.GetReflection()->GetRepeatedString(msgSource,
                                                                                                            pFieldSource,
                                                                                                            i));
                        } else {
                            msgDest.GetReflection()->SetRepeatedString(&msgDest, pFieldDest, i,
                                                                       msgSource.GetReflection()->GetRepeatedString(
                                                                               msgSource, pFieldSource, i));
                        }
                    }
                }
                ...
                case ::google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE: {
                    for (int i = 0; i < nFieldSize; i++) {
                        if (msgDest.GetReflection()->FieldSize(msgDest, pFieldDest) <= i) {
                            msgDest.GetReflection()->AddMessage(&msgDest, pFieldDest)->CopyFrom(
                                    msgSource.GetReflection()->GetRepeatedMessage(msgSource, pFieldSource, i));
                        } else {
                            msgDest.GetReflection()->MutableRepeatedMessage(&msgDest, pFieldDest, i)->CopyFrom(
                                    msgSource.GetReflection()->GetRepeatedMessage(msgSource, pFieldSource, i));
                        }
                    }
                }
            ...
            switch (pFieldDest->cpp_type()) {
                case ::google::protobuf::FieldDescriptor::CPPTYPE_INT32: {
                    msgDest.GetReflection()->SetInt32(&msgDest, pFieldDest,
                                                      msgSource.GetReflection()->GetInt32(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_INT64: {
                    msgDest.GetReflection()->SetInt64(&msgDest, pFieldDest,
                                                      msgSource.GetReflection()->GetInt64(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_UINT32: {
                    msgDest.GetReflection()->SetUInt32(&msgDest, pFieldDest,
                                                       msgSource.GetReflection()->GetUInt32(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_UINT64: {
                    msgDest.GetReflection()->SetUInt64(&msgDest, pFieldDest,
                                                       msgSource.GetReflection()->GetUInt64(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE: {
                    msgDest.GetReflection()->SetDouble(&msgDest, pFieldDest,
                                                       msgSource.GetReflection()->GetDouble(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_FLOAT: {
                    msgDest.GetReflection()->SetFloat(&msgDest, pFieldDest,
                                                      msgSource.GetReflection()->GetFloat(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_BOOL: {
                    msgDest.GetReflection()->SetBool(&msgDest, pFieldDest,
                                                     msgSource.GetReflection()->GetBool(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
                    msgDest.GetReflection()->SetEnum(&msgDest, pFieldDest,
                                                     msgSource.GetReflection()->GetEnum(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
                    msgDest.GetReflection()->SetString(&msgDest, pFieldDest,
                                                       msgSource.GetReflection()->GetString(msgSource, pFieldSource));
                }
                    break;

                case ::google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE: {
                    msgDest.GetReflection()->MutableMessage(&msgDest, pFieldDest)->CopyFrom(
...
//----------------------------------------------------------------------------
    bool IsProtoBufFieldLess(const ::google::protobuf::Message &msgLHS, const ::google::protobuf::Message &msgRHS,
        ...
        switch (pFieldLHS->cpp_type()) {
            ...
            case ::google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
                return Q_stricmp(msgLHS.GetReflection()->GetString(msgLHS, pFieldLHS).c_str(),
                                 msgRHS.GetReflection()->GetString(msgRHS, pFieldRHS).c_str()) > 0;
            }
                break;
...
//----------------------------------------------------------------------------
    ...
    void
    CProtoBufSharedObjectBase::RecursiveAddProtoBufToKV(KeyValues *pKVDest, const ::google::protobuf::Message &msg) {
        using ::google::protobuf::FieldDescriptor;
            ...
            if (pField->is_repeated()) {
                ...
                for (int iRepeated = 0; iRepeated < pReflection->FieldSize(msg, pField); iRepeated++) {
                    ...
                    switch (pField->cpp_type()) {
                        case FieldDescriptor::CPPTYPE_INT32:
                            pKVNode->SetInt(NULL, pReflection->GetRepeatedInt32(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_INT64:
                            pKVNode->SetUint64(NULL, (uint64) pReflection->GetRepeatedInt64(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_UINT32:
                            pKVNode->SetInt(NULL, (int32) pReflection->GetRepeatedUInt32(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_UINT64:
                            pKVNode->SetUint64(NULL, pReflection->GetRepeatedUInt64(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_DOUBLE:
                            pKVNode->SetFloat(NULL, (float) pReflection->GetRepeatedDouble(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_FLOAT:
                            pKVNode->SetFloat(NULL, pReflection->GetRepeatedFloat(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_BOOL:
                            pKVNode->SetBool(NULL, pReflection->GetRepeatedBool(msg, pField, iRepeated));
                            break;
                        case FieldDescriptor::CPPTYPE_ENUM:
                            pKVNode->SetInt(NULL, pReflection->GetRepeatedEnum(msg, pField, iRepeated)->number());
                            break;
                        case FieldDescriptor::CPPTYPE_STRING:
                            pKVNode->SetString(NULL, pReflection->GetRepeatedString(msg, pField, iRepeated).c_str());
                            break;
                ...
                switch (pField->cpp_type()) {
                    case FieldDescriptor::CPPTYPE_INT32:
                        ...
                        break;
                    case FieldDescriptor::CPPTYPE_INT64:
                        pKVDest->SetUint64(pFieldName, (uint64) pReflection->GetInt64(msg, pField));
                        break;
                    case FieldDescriptor::CPPTYPE_UINT32:
                    ...
                    case FieldDescriptor::CPPTYPE_UINT64:
                        ...
                        break;
                    case FieldDescriptor::CPPTYPE_DOUBLE:
                        pKVDest->SetFloat(pFieldName, (float) pReflection->GetDouble(msg, pField));
                        break;
                    case FieldDescriptor::CPPTYPE_FLOAT:
                    ...
                    case FieldDescriptor::CPPTYPE_BOOL:
                        ...
                        break;
                    case FieldDescriptor::CPPTYPE_ENUM:
                        pKVDest->SetInt(pFieldName, pReflection->GetEnum(msg, pField)->number());
                        break;
                    case FieldDescriptor::CPPTYPE_STRING:
                        pKVDest->SetString(pFieldName, pReflection->GetString(msg, pField).c_str());
                        break;
                    case FieldDescriptor::CPPTYPE_MESSAGE: {
