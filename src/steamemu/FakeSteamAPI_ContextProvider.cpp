...
DerivedInterfaceGenerator_Begin(ISteamClient) ;
    ...
    GetISteamGameServer(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    GetISteamMatchmaking(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual ISteamMatchmakingServers *
    GetISteamMatchmakingServers(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    GetISteamGameServerStats(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    GetISteamNetworking(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual ISteamRemoteStorage *
    GetISteamRemoteStorage(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual ISteamScreenshots *
    GetISteamScreenshots(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
STEAM_PRIVATE_API(virtual void *DEPRECATED_GetISteamUnifiedMessages(HSteamUser hSteamuser, HSteamPipe hSteamPipe,
    ...
    GetISteamController(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    GetISteamMusicRemote(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual ISteamHTMLSurface *
    GetISteamHTMLSurface(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
STEAM_PRIVATE_API(virtual void Set_SteamAPI_CCheckCallbackRegisteredInProcess(
        SteamAPI_CheckCallbackRegistered_t func) VFunction_STUB)
    ...
    GetISteamParentalSettings(HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char *pchVersion) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamUser) ;
    ...
    virtual int
    InitiateGameConnection(void *pAuthBlob, int cbMaxAuthBlob, CSteamID steamIDGameServer, uint32 unIPServer,
    ...
    GetVoice(bool bWantCompressed, void *pDestBuffer, uint32 cbDestBufferSize, uint32 *nBytesWritten,
             bool bWantUncompressed_Deprecated = false, void *pUncompressedDestBuffer_Deprecated = 0,
             uint32 cbUncompressedDestBufferSize_Deprecated = 0, uint32 *nUncompressBytesWritten_Deprecated = 0,
             uint32 nUncompressedVoiceDesiredSampleRate_Deprecated = 0) {
        FakeSteamAPI_LogFuncBeingCalled();
        return (EVoiceResult) 0;
    }
    ...
    virtual EVoiceResult
    DecompressVoice(const void *pCompressed, uint32 cbCompressed, void *pDestBuffer, uint32 cbDestBufferSize,
...
DerivedInterfaceGenerator_Begin(ISteamFriends) ;
    ...
    virtual void GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID,
                                            ...
                                            CSteamID *pOutSteamIDMembers, int nMembersCount) VFunction_STUB
    ...
    DownloadClanActivityCounts(ARRAY_COUNT(cClansToRequest) CSteamID *psteamIDClans, int cClansToRequest) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamMatchmaking) ;
    ...
    virtual void AddRequestLobbyListStringFilter(const char *pchKeyToMatch, const char *pchValueToMatch,
                                                 ELobbyComparison eComparisonType) VFunction_STUB
    ...
    virtual bool
    GetLobbyDataByIndex(CSteamID steamIDLobby, int iLobbyData, char *pchKey, int cchKeyBufferSize, char *pchValue,
    ...
    virtual int GetLobbyChatEntry(CSteamID steamIDLobby, int iChatID, CSteamID *pSteamIDUser, void *pvData, int cubData,
                                  EChatEntryType *peChatEntryType) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual void SetLobbyGameServer(CSteamID steamIDLobby, uint32 unGameServerIP, uint16 unGameServerPort,
                                    CSteamID steamIDGameServer) VFunction_STUB
...
DerivedInterfaceGenerator_Begin(ISteamUserStats) ;
    ...
    virtual bool SetAchievement(const char *pchName) {
        ...
        FakeSteamAPI_AppendLog(LogLevel_Info,
                               "Application is setting achievement %s. Returning false to the application.", pchName);
        return false;
    }
    ...
    virtual SteamAPICall_t
    FindOrCreateLeaderboard(const char *pchLeaderboardName, ELeaderboardSortMethod eLeaderboardSortMethod,
    ...
    virtual SteamAPICall_t
    DownloadLeaderboardEntries(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest,
    ...
    virtual SteamAPICall_t
    DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard, CSteamID *prgUsers, int cUsers) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual int
    GetMostAchievedAchievementInfo(char *pchName, uint32 unNameBufLen, float *pflPercent, bool *pbAchieved) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual int
    GetNextMostAchievedAchievementInfo(int iIteratorPrevious, char *pchName, uint32 unNameBufLen, float *pflPercent,
                                       bool *pbAchieved) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamApps) ;
    ...
    virtual bool
    BGetDLCDataByIndex(int iDLC, AppId_t *pAppID, bool *pbAvailable, char *pchName, int cchNameBufferSize) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamMatchmakingServers) ;
    ...
    RequestInternetServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters,
    ...
    virtual HServerListRequest
    RequestFriendsServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters,
                             ISteamMatchmakingServerListResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual HServerListRequest
    RequestFavoritesServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters,
                               ISteamMatchmakingServerListResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual HServerListRequest
    RequestHistoryServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters,
                             ISteamMatchmakingServerListResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual HServerListRequest
    RequestSpectatorServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters,
                               ISteamMatchmakingServerListResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    PingServer(uint32 unIP, uint16 usPort, ISteamMatchmakingPingResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual HServerQuery
    PlayerDetails(uint32 unIP, uint16 usPort, ISteamMatchmakingPlayersResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual HServerQuery
    ServerRules(uint32 unIP, uint16 usPort, ISteamMatchmakingRulesResponse *pRequestServersResponse) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamNetworking) ;
    ...
    virtual bool
    ReadP2PPacket(void *pubDest, uint32 cubDest, uint32 *pcubMsgSize, CSteamID *psteamIDRemote, int nChannel = 0) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    CreateListenSocket(int nVirtualP2PPort, uint32 nIP, uint16 nPort, bool bAllowUseOfPacketRelay) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual SNetSocket_t
    CreateP2PConnectionSocket(CSteamID steamIDTarget, int nVirtualPort, int nTimeoutSec, bool bAllowUseOfPacketRelay) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamRemoteStorage) ;
    ...
    virtual bool
    GetUGCDetails(UGCHandle_t hContent, AppId_t *pnAppID, OUT_STRING() char **ppchName, int32 *pnFileSizeInBytes,
    ...
    virtual int32
    UGCRead(UGCHandle_t hContent, void *pvData, int32 cubDataToRead, uint32 cOffset, EUGCReadAction eAction) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual SteamAPICall_t
    PublishWorkshopFile(const char *pchFile, const char *pchPreviewFile, AppId_t nConsumerAppId, const char *pchTitle,
    ...
    virtual SteamAPICall_t
    EnumerateUserSharedWorkshopFiles(CSteamID steamId, uint32 unStartIndex, SteamParamStringArray_t *pRequiredTags,
    ...
    virtual SteamAPICall_t
    PublishVideo(EWorkshopVideoProvider eVideoProvider, const char *pchVideoAccount, const char *pchVideoIdentifier,
                 const char *pchPreviewFile, AppId_t nConsumerAppId, const char *pchTitle, const char *pchDescription,
    ...
    virtual SteamAPICall_t
    SetUserPublishedFileAction(PublishedFileId_t unPublishedFileId, EWorkshopFileAction eAction) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual SteamAPICall_t
    EnumeratePublishedWorkshopFiles(EWorkshopEnumerationType eEnumerationType, uint32 unStartIndex, uint32 unCount,
...
DerivedInterfaceGenerator_Begin(ISteamScreenshots) ;
    ...
    AddScreenshotToLibrary(const char *pchFilename, const char *pchThumbnailFilename, int nWidth, int nHeight) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual ScreenshotHandle
    AddVRScreenshotToLibrary(EVRScreenshotType eType, const char *pchFilename, const char *pchVRFilename) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamHTTP) ;
    ...
    virtual bool
    SetHTTPRequestHeaderValue(HTTPRequestHandle hRequest, const char *pchHeaderName, const char *pchHeaderValue) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool
    SetHTTPRequestGetOrPostParameter(HTTPRequestHandle hRequest, const char *pchParamName, const char *pchParamValue) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    GetHTTPResponseHeaderSize(HTTPRequestHandle hRequest, const char *pchHeaderName, uint32 *unResponseHeaderSize) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool
    GetHTTPResponseHeaderValue(HTTPRequestHandle hRequest, const char *pchHeaderName, uint8 *pHeaderValueBuffer,
                               uint32 unBufferSize) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    SetHTTPRequestRequiresVerifiedCertificate(HTTPRequestHandle hRequest, bool bRequireVerifiedCertificate) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamController) ;
    ...
    virtual void
    ActivateActionSet(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetHandle) VFunction_STUB
    ...
    virtual void ActivateActionSetLayer(ControllerHandle_t controllerHandle,
                                        ControllerActionSetHandle_t actionSetLayerHandle) VFunction_STUB
    ...
    virtual int
    GetDigitalActionOrigins(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetHandle,
    ...
    virtual void
    StopAnalogActionMomentum(ControllerHandle_t controllerHandle, ControllerAnalogActionHandle_t eAction) VFunction_STUB

    virtual void TriggerHapticPulse(ControllerHandle_t controllerHandle, ESteamControllerPad eTargetPad,
                                    unsigned short usDurationMicroSec) VFunction_STUB
    ...
    virtual bool
    ShowDigitalActionOrigins(ControllerHandle_t controllerHandle, ControllerDigitalActionHandle_t digitalActionHandle,
    ...
    virtual bool
    ShowAnalogActionOrigins(ControllerHandle_t controllerHandle, ControllerAnalogActionHandle_t analogActionHandle,
                            float flScale, float flXPosition, float flYPosition) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamUGC) ;
    ...
    CreateQueryUserUGCRequest(AccountID_t unAccountID, EUserUGCList eListType, EUGCMatchingUGCType eMatchingUGCType,
                              EUserUGCListSortOrder eSortOrder, AppId_t nCreatorAppID, AppId_t nConsumerAppID,
                              uint32 unPage) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual UGCQueryHandle_t
    CreateQueryUGCDetailsRequest(PublishedFileId_t *pvecPublishedFileID, uint32 unNumPublishedFileIDs) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    GetQueryUGCStatistic(UGCQueryHandle_t handle, uint32 index, EItemStatistic eStatType, uint64 *pStatValue) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, uint32 index, uint32 previewIndex, char *pchURLOrVideoID,
    ...
    virtual bool GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, uint32 index, uint32 keyValueTagIndex, char *pchKey,
    ...
    virtual EItemUpdateStatus
    GetItemUpdateProgress(UGCUpdateHandle_t handle, uint64 *punBytesProcessed, uint64 *punBytesTotal) {
        FakeSteamAPI_LogFuncBeingCalled();
    ...
    virtual bool
    GetItemInstallInfo(PublishedFileId_t nPublishedFileID, uint64 *punSizeOnDisk, char *pchFolder, uint32 cchFolderSize,
                       uint32 *punTimeStamp) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    GetItemDownloadInfo(PublishedFileId_t nPublishedFileID, uint64 *punBytesDownloaded, uint64 *punBytesTotal) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual SteamAPICall_t
    AddDependency(PublishedFileId_t nParentPublishedFileID, PublishedFileId_t nChildPublishedFileID) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual SteamAPICall_t
    RemoveDependency(PublishedFileId_t nParentPublishedFileID, PublishedFileId_t nChildPublishedFileID) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
...
DerivedInterfaceGenerator_Begin(ISteamHTMLSurface) ;
    ...
    virtual void
    KeyDown(HHTMLBrowser unBrowserHandle, uint32 nNativeKeyCode, EHTMLKeyModifiers eHTMLKeyModifiers) VFunction_STUB

    virtual void
    KeyUp(HHTMLBrowser unBrowserHandle, uint32 nNativeKeyCode, EHTMLKeyModifiers eHTMLKeyModifiers) VFunction_STUB

    virtual void
    KeyChar(HHTMLBrowser unBrowserHandle, uint32 cUnicodeChar, EHTMLKeyModifiers eHTMLKeyModifiers) VFunction_STUB
    ...
    virtual void
    Find(HHTMLBrowser unBrowserHandle, const char *pchSearchStr, bool bCurrentlyInFind, bool bReverse) VFunction_STUB
    ...
    virtual void SetCookie(const char *pchHostname, const char *pchKey, const char *pchValue, const char *pchPath = "/",
                           RTime32 nExpires = 0, bool bSecure = false, bool bHTTPOnly = false) VFunction_STUB
...
DerivedInterfaceGenerator_Begin(ISteamInventory) ;
    ...
    virtual bool GetResultItems(SteamInventoryResult_t resultHandle, SteamItemDetails_t *pOutItemsArray,
    ...
    virtual bool
    GetResultItemProperty(SteamInventoryResult_t resultHandle, uint32 unItemIndex, const char *pchPropertyName,
    ...
    virtual bool GetItemsByID(SteamInventoryResult_t *pResultHandle, const SteamItemInstanceID_t *pInstanceIDs,
    ...
    virtual bool DeserializeResult(SteamInventoryResult_t *pOutResultHandle, const void *pBuffer, uint32 unBufferSize,
                                   bool bRESERVED_MUST_BE_FALSE = false) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool GenerateItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs,
    ...
    virtual bool
    AddPromoItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, uint32 unArrayLength) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool
    ConsumeItem(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemConsume, uint32 unQuantity) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool ExchangeItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayGenerate,
    ...
    virtual bool
    TransferItemQuantity(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemIdSource, uint32 unQuantity,
    ...
    virtual bool
    GetItemDefinitionProperty(SteamItemDef_t iDefinition, const char *pchPropertyName, char *pchValueBuffer,
    ...
    virtual bool
    GetEligiblePromoItemDefinitionIDs(CSteamID steamID, SteamItemDef_t *pItemDefIDs, uint32 *punItemDefIDsArraySize) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual SteamAPICall_t
    StartPurchase(const SteamItemDef_t *pArrayItemDefs, const uint32 *punArrayQuantity, uint32 unArrayLength) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }
    ...
    virtual bool
    RemoveProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName) {
        FakeSteamAPI_LogFuncBeingCalled();
        return 0;
    }

    virtual bool
    SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName,
