...
public:
    ...
    virtual void
    GetFileAndDirLists(const char *pFindWildCard, CUtlStringList &outDirnames, CUtlStringList &outFilenames,
...
#pragma pack()
    ...
    bool
    GetFileInfo(const char *pFileName, int &nBaseIndex, int64 &nFileOffset, int &nOriginalSize, int &nCompressedSize,
