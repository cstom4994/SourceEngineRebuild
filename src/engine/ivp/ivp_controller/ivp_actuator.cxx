...
void IVP_Template_Anchor::set_anchor_position_ws(IVP_Real_Object *obj, const IVP_DOUBLE x, const IVP_DOUBLE y,
                                                 const IVP_DOUBLE z) {
    this->object = obj;
...
void IVP_Template_Anchor::set_anchor_position_os(IVP_Real_Object *obj, const IVP_DOUBLE x, const IVP_DOUBLE y,
                                                 const IVP_DOUBLE z) {
    this->object = obj;
...
void IVP_Template_Anchor::set_anchor_position_cs(IVP_Real_Object *obj, const IVP_DOUBLE x, const IVP_DOUBLE y,
                                                 const IVP_DOUBLE z) {
    this->object = obj;
...
void IVP_Anchor_Check_Dist::init_anchor_check_dist(IVP_Real_Object *object, IVP_U_Point *position_world_space,
...
void IVP_Actuator_Two_Point::ensure_actuator_in_simulation() {
    get_actuator_anchor(
            0)->l_anchor_object->get_environment()->get_controller_manager()->ensure_controller_in_simulation(this);
}
...
void IVP_Actuator_Check_Dist::hull_limit_exceeded_event() {
    ...
    IVP_DOUBLE new_delta_hull =
            IVP_Inline_Math::fabsd(len - this->range) * 0.5f; // @@@ maybe unequal hull vals, dependant on cur sur speed
...
IVP_U_Point *IVP_Actuator_Extra::get_float_cam_props(IVP_DOUBLE *fc_height_out, IVP_DOUBLE *fc_target_height_out,
...
void IVP_Actuator_Extra::do_float_cam(IVP_DOUBLE d_time) {
    ...
    if (this->current_vals_are_set == IVP_FALSE) {
        ...
        this->current_look_point.set_interpolate(&current_look_point, &look_point,
