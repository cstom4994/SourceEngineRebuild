...
public:
    ...
    virtual void phantom_is_going_to_be_deleted_event(
            class IVP_Controller_Phantom *controller) = 0;  // indicates either object is deleted or phantom is converted to object
...
protected:
    ...
    IVP_Controller_Phantom(IVP_Real_Object *object,
                           const IVP_Template_Phantom *templat); // use IVP_Real_Object::convert_to_phantom to create phantoms
...
public:
    ...
    get_intruding_objects() const { return set_of_objects; };  // returns NULL if manage_set was IVP_FALSE
    IVP_U_Set_Active<IVP_Core> *
    get_intruding_cores() const { return set_of_cores; };  // returns NULL if manage_set was IVP_FALSE
    IVP_U_Set_Active<IVP_Mindist_Base> *
    get_intruding_mindists() { return &set_of_mindists; };             // returns mindist
