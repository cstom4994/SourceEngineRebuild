...
private:
    void init_trans_ws(const IVP_U_Point *pos_ws, IVP_Core *core, IVP_U_Point_4 cross_direction_position_cs[3],
                       IVP_U_Point_4 cr_mult_inv[3], IVP_FLOAT sign);

    void init_rot_ws(IVP_Core *core, IVP_U_Point_4 cross_direction_position_cs[3], IVP_U_Point_4 cr_mult_inv[3],
                     IVP_FLOAT sign);
