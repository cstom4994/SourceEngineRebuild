...
public:
    ...
    void
    align_matrix_values();  //shift 'matrix_values' to aligned memory when malloc gives not aligned memory; Warning when using 'delete' afterwards
    ...
    IVP_RETURN_TYPE solve_lower_null_matrix_unsymmetrical(int *col_is_original, int *columns_went_inactive,
...
public:
    static inline void
    fpu_add_multiple_row(IVP_DOUBLE *target_adress, IVP_DOUBLE *source_adress, IVP_DOUBLE factor, int size,
                         IVP_BOOL adress_aligned);

    static inline void
    fpu_multiply_row(IVP_DOUBLE *target_adress, IVP_DOUBLE factor, int size, IVP_BOOL adress_aligned);

    static inline void
    fpu_exchange_rows(IVP_DOUBLE *target_adress1, IVP_DOUBLE *target_adress2, int size, IVP_BOOL adress_aligned);

    static inline void
    fpu_copy_rows(IVP_DOUBLE *target_adress, IVP_DOUBLE *source_adress, int size, IVP_BOOL adress_aligned);

    static inline void fpu_set_row_to_zero(IVP_DOUBLE *target_adress, int size, IVP_BOOL adress_aligned);

    static inline IVP_DOUBLE
    fpu_large_dot_product(IVP_DOUBLE *base_a, IVP_DOUBLE *x, int size, IVP_BOOL adress_aligned);
};
...
public:
    ...
    IVP_RETURN_TYPE
    init_and_solve_lc(IVP_DOUBLE *A_in, IVP_DOUBLE *b_in, IVP_DOUBLE *result_vec_out, int var_num, int actives_at_begin,
                      IVP_U_Memory *my_mem);
};
