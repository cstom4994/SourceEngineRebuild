...
void IVP_Clustering_Visualizer_Shortrange::add_node_to_pipeline(const IVP_Compact_Ledgetree_Node *node,
                                                                IVP_BOOL reported_ledge) {

    int x;
    for (x = 0; x < this->pipelined_private_property_data->ledgetree_nodes.len(); x++) {
        IVP_Clustering_Visualizer_Shortrange_Nodedata *nodedata = this->pipelined_private_property_data->ledgetree_nodes.element_at(
                x);
...
void IVP_Clustering_Visualizer_Shortrange::analyze_collision(IVP_Real_Object *object0, IVP_DOUBLE radius0,
    ...
    for (x = 0; x < 2; x++) {
        ...
        object_cache->transform_position_to_object_coords(&intruder_matrix.vv,
                                                          &this->intruder_position_in_private_property_cs);
...
void IVP_Clustering_Visualizer_Shortrange::add_object_to_intruder_filter(IVP_Real_Object *obj,
...
void IVP_Clustering_Visualizer_Shortrange::remove_object_from_intruder_filter(IVP_Real_Object *obj,
                                                                              IVP_CLUSTERING_VISUALIZER_FILTER filter) {
...
void IVP_Clustering_Visualizer_Shortrange::add_object_to_private_property_filter(IVP_Real_Object *obj,
                                                                                 IVP_CLUSTERING_VISUALIZER_FILTER filter) {
...
void IVP_Clustering_Visualizer_Shortrange::remove_object_from_private_property_filter(IVP_Real_Object *obj,
                                                                                      IVP_CLUSTERING_VISUALIZER_FILTER filter) {
...
IVP_Clustering_Visualizer_Longrange_Hash::IVP_Clustering_Visualizer_Longrange_Hash(int create_size) : IVP_VHash(
        create_size) {
...
void IVP_Clustering_Visualizer_Longrange::add_object(IVP_Real_Object *real_object, IVP_U_Float_Point *center,
                                                     IVP_DOUBLE radius) {
...
void
IVP_Clustering_Visualizer_Longrange::remove_visualize_callback(IVP_Clustering_Visualizer_Longrange_Callback *callback) {
...
void IVP_Clustering_Visualizer_Longrange::add_object_to_filter(IVP_Real_Object *obj,
                                                               IVP_CLUSTERING_VISUALIZER_FILTER filter) {
...
void IVP_Clustering_Visualizer_Longrange::remove_object_from_filter(IVP_Real_Object *obj,
                                                                    IVP_CLUSTERING_VISUALIZER_FILTER filter) {
