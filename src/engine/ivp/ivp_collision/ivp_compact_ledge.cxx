...
int IVP_Compact_Edge::next_table[] = {0, 1 * int(sizeof(IVP_Compact_Edge)), 1 * int(sizeof(IVP_Compact_Edge)),
                                      -2 * int(sizeof(IVP_Compact_Edge))};
int IVP_Compact_Edge::prev_table[] = {0, 2 * int(sizeof(IVP_Compact_Edge)), -1 * int(sizeof(IVP_Compact_Edge)),
