...
void IVP_Ray_Solver_Min_Hash::add_hit_object(IVP_Real_Object *object, const IVP_Compact_Ledge *compact_ledge,
...
IVP_BOOL IVP_Ray_Solver_Group::check_ray_group_against_sphere(const IVP_U_Float_Point *sphere_center_ws,
                                                              IVP_FLOAT sphere_radius) {
    // returns IVP_FALSE if sphere is not hit by ray
    IVP_U_Float_Point delta_vec;
...
IVP_BOOL
IVP_Ray_Solver_Os::check_ray_against_sphere_os(const IVP_U_Float_Point *sphere_center_os, IVP_FLOAT sphere_radius) {
    // returns IVP_FALSE if sphere is not hit by ray
...
IVP_BOOL
IVP_Ray_Solver_Group::check_ray_group_against_cube(const IVP_U_Float_Point *cube_center_ws, IVP_FLOAT cube_size) {
...
void IVP_Ray_Solver::check_ray_against_node(IVP_OV_Node *node, IVP_OV_Tree_Manager *ov_tree_man) {
    ...
    IVP_FLOAT cubesize;
    ov_tree_man->get_luf_coordinates_ws(node, &luf_point,
...
void IVP_Ray_Solver_Min::add_hit_object(IVP_Real_Object *object, const IVP_Compact_Ledge *compact_ledge,
                                        const IVP_Compact_Triangle *compact_triangle, IVP_DOUBLE hit_dist,
                                        IVP_U_Point *hit_sur_vec_os) {
