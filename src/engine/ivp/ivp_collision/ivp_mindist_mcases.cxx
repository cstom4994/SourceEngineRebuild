...
IVP_MRC_TYPE IVP_Mindist_Minimize_Solver::p_minimize_BF(IVP_Cache_Ball *m_cache_B, const IVP_Compact_Edge *F,
    ...
    if (!qr.is_outside()) {
        ...
        IVP_CLS.calc_hesse_vec_object_not_normized(F, m_cache_F->get_compact_ledge(),
...
IVP_MRC_TYPE IVP_Mindist_Minimize_Solver::p_minimize_Leave_KK(const IVP_Compact_Edge *K, const IVP_Compact_Edge *L,
    ...
    {
        IVP_DOUBLE dist_next = IVP_CLS.calc_qlen_KK(min_edge, min_plane->get_next(), min_edge_m_cache,
                                                    min_plane_m_cache);
        IVP_DOUBLE dist_prev = IVP_CLS.calc_qlen_KK(min_edge, min_plane->get_prev()->get_opposite(), min_edge_m_cache,
                                                    min_plane_m_cache);
...
IVP_MRC_TYPE IVP_Mindist_Minimize_Solver::p_minimize_BP(IVP_Cache_Ball *m_cache_ball, const IVP_Compact_Edge *P,
                                                        IVP_Cache_Ledge_Point *m_cache_P) {
...
IVP_MRC_TYPE IVP_Mindist_Minimize_Solver::p_minimize_Leave_BK(IVP_Cache_Ball *m_cache_ball, const IVP_Compact_Edge *K,
    ...
    const IVP_U_Float_Point *k_tri_os = IVP_CLS.give_object_coords(K->get_prev(),
                                                                   m_cache_K);    // prev point == other point of this triange
    const IVP_U_Float_Point *k_oppo_tri_os = IVP_CLS.give_object_coords(K->get_opposite()->get_prev(),
                                                                        m_cache_K);    // point of opposite triangle
