...
void IVP_Mindist_Event_Solver::calc_next_event_KK(const IVP_Compact_Edge *K,
    ...
    /** detect collision time, first **/
    {
        ...
        IVP_DOUBLE found =
                solver_kk_coll.find_first_t_for_value_coll(mindist->get_coll_dist(),
                                                           ivp_mindist_settings.real_coll_dist,
    ...
    IVP_3D_Solver_KK_PARALLEL solver_kk_parallel;
    {
        ...
        IVP_DOUBLE dev =
                sum_abs_omega + sum_abs_omega; // as kk parallel calcs the quadratic length we have to adjust dev:
    ...
    for (int i = 0; i <= 3; i++) {
        ...
        IVP_CLS.calc_hesse_vec_object_not_normized(f, m_cache_tab[3 - i]->get_compact_ledge(),
...
void IVP_Mindist_Event_Solver::calc_next_event_PP(const IVP_Compact_Edge *P,
    ...
    // check s vals for sector change
    {
        ...
        { // deviation calculation
            ...
            IVP_DOUBLE object_radius = P_MAX(m_cache_P->get_core()->upper_limit_radius,
...
void IVP_Mindist_Event_Solver::calc_next_event_PK(const IVP_Compact_Edge *P,
    ...
    IVP_DOUBLE max_dev;
    {
        ...
        IVP_DOUBLE speed_K = m_cache_K->get_core()->max_surface_rot_speed * solver_K->abs_omega +
