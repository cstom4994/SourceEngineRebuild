...
public:
    ...
    delegate_collisions_for_object(IVP_Real_Object *base_object, IVP_Real_Object *colliding_element);
...
public:
    ...
    void hull_manager_is_going_to_be_deleted_event(
            IVP_Hull_Manager *);        // function have to remove itself from hull manager
};
...
protected:
    ...
    void init_synapse(IVP_Mindist *min, IVP_Real_Object *object_to_link, const IVP_Compact_Edge *e,
...
public:
     ...
     ********************************************************************************/
    void
    init_mindist(IVP_Real_Object *pop0, IVP_Real_Object *pop1, const IVP_Compact_Edge *e0, const IVP_Compact_Edge *e1);
     ...
     ********************************************************************************/
    void update_exact_mindist_events(IVP_BOOL allow_hull_conversion,
                                     IVP_MINDIST_EVENT_HINT allow_events_at_now);            // after recalc_mindist check for collision
     ...
     *			it's quite robust
     ********************************************************************************/
    IVP_Contact_Point *try_to_generate_managed_friction(IVP_Friction_System **associated_fs, IVP_BOOL *having_new,
...
class IVP_Mindist_Recursive : public IVP_Mindist, public IVP_Collision_Delegator {
    ...
    virtual void
    collision_is_going_to_be_deleted_event(class IVP_Collision *t);  // should remove t from its internal structures
...
public:
    ...
    void insert_and_recalc_exact_mindist(
            IVP_Mindist *new_mindist);    // insert no phantoms in linked list and recalc and update_events
    void insert_and_recalc_phantom_mindist(
            IVP_Mindist *new_mindist);    // insert phantoms in linked list and recalc and update_events
