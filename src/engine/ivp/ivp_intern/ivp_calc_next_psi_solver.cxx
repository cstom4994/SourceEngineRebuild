...
void IVP_Calc_Next_PSI_Solver::calc_next_PSI_matrix(IVP_Event_Sim *event_sim,
    ...
    for (int c = core->objects.len() - 1; c >= 0; c--) {
        ...
        IVP_Hull_Manager *h_manager = r_obj->get_hull_manager();
        h_manager->increase_hull_by_x(event_sim->environment->get_current_time(), event_sim->delta_time, new_speed,
                                      core->current_speed);
...
void IVP_Calc_Next_PSI_Solver::set_transformation(const IVP_U_Quat *rotation, const IVP_U_Point *position,
    ...
    // calc rotation axis in world space and rotation speed. using quaternions
    IVP_DOUBLE diff =
            core->max_surface_deviation * core->max_surface_rot_speed * simulation_delta_time + moved_distance_val;
...
void IVP_Calc_Next_PSI_Solver::commit_all_calc_next_PSI_matrix(IVP_Environment *env,
...
void IVP_Calc_Next_PSI_Solver::commit_one_hull_manager(IVP_Environment *,
...
void IVP_Calc_Next_PSI_Solver::commit_all_hull_managers(IVP_Environment *,
                                                        IVP_U_Vector<IVP_Hull_Manager_Base> *active_hull_managers) {
    //h_manager->check_hull_synapses();
    //h_manager->check_for_reset();
    int i;
