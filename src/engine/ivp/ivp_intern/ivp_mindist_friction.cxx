...
void IVP_Contact_Point::p_calc_friction_s_PP(const IVP_U_Point *pp0, const IVP_U_Point *pp1,
...
void IVP_Contact_Point::recalc_friction_s_vals() {
    ...
    IVP_Impact_Solver_Long_Term *info = (IVP_Impact_Solver_Long_Term *) env->get_sim_unit_mem()->get_mem_transaction(
            sizeof(IVP_Impact_Solver_Long_Term));
...
// #+# maybe optimize! e.g.: obj-coords of point synapse never change !
    ...
    {// calculate some values plus pretension for core 0
        ...
        if (!core0->physical_unmoveable) { // && !core0->pinned){ //@@CBPIN
            ...
            core0->get_surface_speed_on_test(&info->contact_point_cs[0], &core0->speed, &core0->rot_speed,
                                             &delta_velocity_ws);
