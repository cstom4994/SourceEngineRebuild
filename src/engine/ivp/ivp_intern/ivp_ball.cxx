...
public:
    ...
    virtual void get_radius_and_radius_dev_to_given_center(const IVP_U_Float_Point * /*center*/, IVP_FLOAT * /*radius*/,
    ...
    virtual void insert_all_ledges_hitting_ray(IVP_Ray_Solver * /*ray_solver*/,
                                               IVP_Real_Object * /*object_to_insert*/) { CORE; }; // dummy
...
IVP_Ball::IVP_Ball(IVP_Cluster *father, const IVP_Template_Ball *tball, const IVP_Template_Real_Object *templ,
