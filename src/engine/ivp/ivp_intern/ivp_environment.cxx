...
IVP_Environment::create_controller_motion(IVP_Real_Object *obj, const IVP_Template_Controller_Motion *templ) {
...
void ivp_dummy_func() {
    ...
    IVP_Attacher_To_Cores<IVP_Controller_Buoyancy> *ivp_class_dummy8 = new IVP_Attacher_To_Cores<IVP_Controller_Buoyancy>(
            NULL);
...
void IVP_Environment::add_draw_vector(const IVP_U_Point *start_p, const IVP_U_Float_Point *dir_vec,
