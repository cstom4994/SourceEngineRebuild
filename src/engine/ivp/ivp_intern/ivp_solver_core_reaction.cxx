...
void IVP_Solver_Core_Reaction::init_trans_ws(const IVP_U_Point *pos_ws, IVP_Core *core,
    ...
    // direction_ws[0]
    {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(0, 0) + cr_mult_inv[0].dot_product4(cross_direction_position_cs[0]);
        m_velocity_ds_f_impulse_ds.set_elem(0, 0, val);

        IVP_DOUBLE a =
                core->rot_speed.dot_product(&cross_direction_position_cs[0]) + core->speed.dot_product(direction_ws[0]);
    ...
    if (direction_ws[1]) {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(1, 1) + cr_mult_inv[1].dot_product4(cross_direction_position_cs[1]);
        ...
        IVP_DOUBLE a =
                core->rot_speed.dot_product(&cross_direction_position_cs[1]) + core->speed.dot_product(direction_ws[1]);
    ...
    if (direction_ws[2]) {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(2, 2) + cr_mult_inv[2].dot_product4(cross_direction_position_cs[2]);
        ...
        IVP_DOUBLE a =
                core->rot_speed.dot_product(&cross_direction_position_cs[2]) + core->speed.dot_product(direction_ws[2]);
...
void IVP_Solver_Core_Reaction::init_rot_ws(IVP_Core *core, IVP_U_Point_4 cross_direction_position_cs[3],
    ...
    // direciton_ws[0]
    {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(0, 0) + cr_mult_inv[0].dot_product(&cross_direction_position_cs[0]);
        m_velocity_ds_f_impulse_ds.set_elem(0, 0, val);
    ...
    if (direction_ws[1]) {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(1, 1) + cr_mult_inv[1].dot_product(&cross_direction_position_cs[1]);
        m_velocity_ds_f_impulse_ds.set_elem(1, 1, val);
    ...
    if (direction_ws[2]) {
        ...
        IVP_DOUBLE val =
                m_velocity_ds_f_impulse_ds.get_elem(2, 2) + cr_mult_inv[2].dot_product(&cross_direction_position_cs[2]);
        m_velocity_ds_f_impulse_ds.set_elem(2, 2, val);
...
void
IVP_Solver_Core_Reaction::init_reaction_solver_translation_ws(IVP_Core *core_0, IVP_Core *core_1, IVP_U_Point &pos_ws,
...
void IVP_Solver_Core_Reaction::exert_angular_impulse_dim3(IVP_Core *core_0, IVP_Core *core_1,
...
void IVP_Solver_Core_Reaction::exert_angular_impulse_dim2(IVP_Core *core_0, IVP_Core *core_1,
                                                          IVP_U_Float_Point &impulse_ds) {
    if (core_0) {
        core_0->rot_speed.add_multiple(&cr_mult_inv0[0], impulse_ds.k[0]);
        core_0->rot_speed.add_multiple(&cr_mult_inv0[1], impulse_ds.k[1]);
...
void IVP_Solver_Core_Reaction::exert_angular_impulse_dim1(IVP_Core *core_0, IVP_Core *core_1,
                                                          IVP_U_Float_Point &impulse_ds) {
    if (core_0) {
        core_0->rot_speed.add_multiple(&cr_mult_inv0[0], impulse_ds.k[0]);
    }
