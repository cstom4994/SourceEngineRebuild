...
public:
    ...
    inline hk_Fixed_Dense_Matrix<N> &get_fixed_dense_matrix() { return m_dense_matrix; }

    inline hk_Cached_Force_Axis_Description *
    get_cfad_buffer_0() { return (hk_Cached_Force_Axis_Description *) &m_buffer_0[0]; }

    inline hk_Cached_Force_Axis_Description *
    get_cfad_buffer_1() { return (hk_Cached_Force_Axis_Description *) &m_buffer_1[0]; }

    inline hk_real *get_velocities() { return m_velocities; }

    inline hk_Virtual_Mass_Query *get_vmq(int x) { return (hk_Virtual_Mass_Query *) &m_impulse_info[x][0]; }
