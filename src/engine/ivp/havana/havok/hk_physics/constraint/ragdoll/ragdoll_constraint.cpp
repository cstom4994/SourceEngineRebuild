...
void
hk_Ragdoll_Constraint::init_ragdoll_constraint(const hk_Ragdoll_Constraint_BP *bp, hk_Local_Constraint_System *sys) {
...
void hk_Ragdoll_Constraint::apply_angular_part(hk_PSI_Info &pi, hk_Ragdoll_Constraint_Work &work,
    ...
    do {
        ...
        hk_Constraint_Limit_Util::do_angular_plane_limit(pi, b0, b1, dir_ws, plane_dir_ws, current_pos, limit,
                                                         tau_factor, strength_factor);
    } while (--i >= 1);
}
