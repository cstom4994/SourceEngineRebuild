...
public:
    ...
    virtual void calc_step(hk_real y0[], hk_real y1[], unsigned int len, hk_real t0, hk_real t1, dydt_function dydt,
                           void *client_data) = 0;
...
public:
    ...
    void calc_step(hk_real y0[], hk_real y1[], unsigned int len, hk_real t0, hk_real t1, dydt_function dydt,
                   void *client_data);
