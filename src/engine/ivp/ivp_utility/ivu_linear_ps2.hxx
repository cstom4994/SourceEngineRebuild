...
inline void IVP_U_Float_Point::set_pairwise_mult(const IVP_U_Float_Point *v1,
...
inline void IVP_U_Float_Point::add_multiple(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2,
...
inline void IVP_U_Float_Point::inline_subtract_and_mult(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2,
...
void
IVP_U_Float_Point::inline_calc_cross_product_and_normize(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2) {
#if 0
    IVP_DOUBLE a  = v1->k[1] * v2->k[2];
    IVP_DOUBLE a2 = v2->k[1] * v1->k[2];
    IVP_DOUBLE b  = v1->k[2] * v2->k[0];	
...
void IVP_U_Float_Point::inline_set_vert_to_area_defined_by_three_points(const IVP_U_Float_Point *tp0,
...
#nop
    ...
    vf8, vf8, vf9
    vsuby.w
    vf12, vf12, vf12        # vf12.w = ww - xx - yy
#nop nop
    vadd.xyz
    vf8, vf8, vf6
    vsubz.w
    vf8, vf12, vf12         # vf8.w = ww - xx - yy - zz
#nop nop nop
    sqc2
    vf8, 0x0( % 0)
    "
