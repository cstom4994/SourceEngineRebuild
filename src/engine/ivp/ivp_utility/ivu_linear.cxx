...
void IVP_U_Point::solve_quadratic_equation_fast(
        const IVP_U_Point *p) {    // points stores quadratic equ. k[2] + x*k[1] * x^2 * k[0]
...
void IVP_U_Float_Hesse::calc_hesse(const IVP_U_Float_Point *tp0, const IVP_U_Float_Point *tp1,
                                   const IVP_U_Float_Point *tp2) {
    IVP_DOUBLE a0, a1, a2, b0, b1, b2;
...
void IVP_U_Matrix::init_rows4(const IVP_U_Point *v0, const IVP_U_Point *v1, const IVP_U_Point *v2,
...
void IVP_U_Matrix::init_columns4(const IVP_U_Point *v0, const IVP_U_Point *v1, const IVP_U_Point *v2,
                                 const IVP_U_Point *shift) {
    set_elem(0, 0, v0->k[0]);
    set_elem(1, 0, v0->k[1]);
    set_elem(2, 0, v0->k[2]);
...
void IVP_U_Matrix::init_rot_multiple(const IVP_U_Point *angles,
