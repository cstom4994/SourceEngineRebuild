...
public:
    ...
    inline void
    set_pairwise_mult(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2);    // this->k[i] = v1->k[i] * v2->k[i]
    ...
    inline void inline_subtract_and_mult(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2,
                                         IVP_DOUBLE factor); // this = (v1-v2) * factor
#if !defined(IVP_NO_DOUBLE)

    inline void inline_subtract_and_mult(const IVP_U_Point *v1, const IVP_U_Point *v2,
                                         IVP_DOUBLE factor); // this = (v1-v2) * factor
#endif
    ...
    inline void
    inline_calc_cross_product_and_normize(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2); // this = v1 x v2

    inline void
    inline_set_vert_to_area_defined_by_three_points(const IVP_U_Float_Point *tp0, const IVP_U_Float_Point *tp1,
    ...
    void set_orthogonal_part(const IVP_U_Float_Point *vector,
                             const IVP_U_Float_Point *normal_v);   //project vector on surface given by normal_v
...
#	endif
    ...
    inline void add_multiple(const IVP_U_Float_Point *v, IVP_DOUBLE factor);    // this += v1 * factor
    inline void
    add_multiple(const IVP_U_Point *v1, const IVP_U_Point *v2, IVP_DOUBLE factor2); // this = v1 + factor2*v2  .
    inline void
    add_multiple(const IVP_U_Point *v1, const IVP_U_Float_Point *v2, IVP_DOUBLE factor2); // this = v1 + factor2*v2  .
    ...
    inline void
    set_pairwise_mult(const IVP_U_Point *v1, const IVP_U_Float_Point *v2);    // this->k[i] = v1->k[i] * v2->k[i]


    inline void inline_set_vert_to_area_defined_by_three_points(const IVP_U_Point *tp0, const IVP_U_Point *tp1,
    ...
    void set_orthogonal_part(const IVP_U_Point *vector,
                             const IVP_U_Point *normal_v); //project vector on surface given by normal_v
    void set_orthogonal_part(const IVP_U_Point *vector,
                             const IVP_U_Float_Point *normal_v); //project vector on surface given by normal_v
    IVP_RETURN_TYPE
    set_crossing(IVP_U_Hesse *h0, IVP_U_Hesse *h1, IVP_U_Hesse *h2); // set this to the crossing of three areas
...
public:
    ...
    void proj_on_plane(const IVP_U_Point *p,
                       IVP_U_Point *result) const;    // sets result to a point on the plane and nearest to p
    void mult_hesse(IVP_DOUBLE factor);                        // scale the hesse
    void normize();                                // normize hesse (->super.calc_quad_length() == 1.0f)
#if !defined(IVP_NO_DOUBLE)

    inline IVP_DOUBLE
    get_dist(const IVP_U_Point *p) const;                // get the distance between a point and the plane
#endif

    inline IVP_DOUBLE
    get_dist(const IVP_U_Float_Point *p) const;            // get the distance between a point and the plane
    IVP_RETURN_TYPE
    calc_intersect_with(const IVP_U_Straight *straight,        // calc the intersection between a straight and the plane
...
public:
    ...
    void proj_on_plane(const IVP_U_Float_Point *p,
                       IVP_U_Float_Point *result) const;    // sets result to a point on the plane and nearest to p
    void mult_hesse(IVP_DOUBLE factor);                        // scale the hesse
    void normize();                                // normize hesse (->super.calc_quad_length() == 1.0f)
...
public:
    ...
    void mmult3(const IVP_U_Matrix3 *mb,
                IVP_U_Matrix3 *m_out) const;    // m_out = this * mb, note: note: in place operation allowed
    void mimult3(const IVP_U_Matrix3 *mb,
                 IVP_U_Matrix3 *m_out) const;    // m_out = (this^-1) * mb, note: in place operation allowed
    void mi2mult3(const IVP_U_Matrix3 *mb,
                  IVP_U_Matrix3 *m_out) const; // m_out = this * (mb^-1), note: in place operation allowed
    ...
    inline void
    inline_vimult3(const IVP_U_Point *p_in, IVP_U_Point *p_out) const;                    // p_out = (this^-1) * p_in
    ...
    void
    init_rows3(const IVP_U_Point *v0, const IVP_U_Point *v1, const IVP_U_Point *v2);    // sets this rows    to v0,v1,v2
     ...
     ********************************************************************************/
    void init_normized3_col(const IVP_U_Point *v,
                            IVP_COORDINATE_INDEX coordinate_index);      // init orthornomized matrix given any axis
    void init_normized3_col(const IVP_U_Point *vb, IVP_COORDINATE_INDEX coordinate_index,
                            const IVP_U_Point *vc);      // init orthornomized matrix given any two axes
    void init_normized3_row(const IVP_U_Point *v,
                            IVP_COORDINATE_INDEX coordinate_index);      // init orthornomized matrix given any axis
    void init_normized3_row(const IVP_U_Point *vb, IVP_COORDINATE_INDEX coordinate_index,
                            const IVP_U_Point *vc);      // init orthornomized matrix given any two axes

    void
    init_rotated3(IVP_COORDINATE_INDEX axis, IVP_FLOAT angle);  // init this matrix as a rotation around the given axis
...
public:
    ...
    inline void inline_vmult4(const IVP_U_Float_Point *p_in,
                              IVP_U_Float_Point *p_out) const;    // p_out = this * p_in (e.g. object space to core space)
    ...
    inline void
    inline_vimult4(const IVP_U_Point *p_in, IVP_U_Point *p_out) const;            // p_out = (this^-1) * p_in
    ...
    inline void
    inline_vimult4(const IVP_U_Float_Point *p_in, IVP_U_Float_Point *p_out) const;    // p_out = (this^-1) * p_in
    void
    vimult4(const IVP_U_Float_Point *p_in, IVP_U_Float_Point *p_out) const;            // p_out = (this^-1) * p_in
    ...
    void init_rot_multiple(const IVP_U_Point *angles,
                           IVP_DOUBLE factor = 1.0f);    // sets this rotated (using euler angles) and position to 0,0,0
    ...
    void interpolate(const IVP_U_Matrix *m1, const IVP_U_Matrix *m2,
...
public:
    ...
    void set_fast_multiple(const IVP_U_Point *angles,
                           IVP_DOUBLE factor); // sets x = sin( angles.k[0] * factor * 0.5f), y = ..   , w= 1 - sqrt(xx+yy+zz), lets the engine crash for angles > PI
    ...
    void
    fast_normize_quat();           // works only on quads with |quad| = 1.0f +- 0.1f; very fast if quat is already nearly normized
    ...
    void
    set_from_rotation_vectors(IVP_DOUBLE x1, IVP_DOUBLE y1, IVP_DOUBLE z1, IVP_DOUBLE x2, IVP_DOUBLE y2, IVP_DOUBLE z2);
    ...
    void
    set_div_unit_quat(const IVP_U_Quat *q1, const IVP_U_Quat *q2); // res = q1/q2; set div, if both quats are unit quats
    ...
    inline IVP_DOUBLE
    inline_estimate_q_diff_to(const IVP_U_Float_Quat *reference) const;    // roughly estimate the quad alpha
