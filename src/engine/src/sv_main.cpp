...
ConVar sv_shutdown_timeout_minutes("sv_shutdown_timeout_minutes", "360", FCVAR_REPLICATED,
...
ConVar sv_mincmdinterval("sv_mincmdinterval", "0.015", FCVAR_REPLICATED,
                         "This sets the minimum value for cl_cmdinterval. 0 == unlimited.");
ConVar sv_maxcmdinterval("sv_maxcmdinterval", "0.015", FCVAR_REPLICATED,
                         "(If sv_mincmdinterval is > 0), this sets the maximum value for cl_cmdinterval.");
...
void SV_StartSound(IRecipientFilter &filter, edict_t *pSoundEmittingEntity, int iChannel,
                   ...
                   int iPitch, int iSpecialDSP, const Vector *pOrigin, float soundtime, int speakerentity,
...
static void SV_AllocateEdicts() {
    ...
    sv.edictchangeinfo = (IChangeInfoAccessor *) Hunk_AllocName(sv.max_edicts * sizeof(IChangeInfoAccessor),
                                                                "edictchangeinfo");
}
