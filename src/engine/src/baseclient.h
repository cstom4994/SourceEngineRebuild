...
public:
    ...
    virtual void
    Connect(const char *szName, int nUserID, INetChannel *pNetChannel, bool bFakePlayer, int clientChallenge);
    ...
    virtual bool IsSplitScreenUser(
            void) const { return false; } // !KLUDGE! We don't have splitscreen support, but this makes merges easier
