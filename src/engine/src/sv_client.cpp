...
static ConVar sv_minrate("sv_minrate", V_STRINGIFY(MIN_RATE), FCVAR_REPLICATED,
                         "Min bandwidth rate allowed on server, 0 == unlimited");

ConVar sv_maxupdateinterval("sv_maxupdateinterval", "0.015", FCVAR_REPLICATED,
                            "Maximum time between updates that the server will allow");
ConVar sv_minupdateinterval("sv_minupdateinterval", "0.015", FCVAR_REPLICATED,
                            "Minimum time between updates that the server will allow");
...
void
CGameClient::Connect(const char *szName, int nUserID, INetChannel *pNetChannel, bool bFakePlayer, int clientChallenge) {
