...
inline unsigned char *UpdateRoutesExplicit_Template(DTStack *pStack, ProxyCaller *caller) {
    ...
    for (unsigned short i = 0; i < proxyPath.m_nEntries; i++) {
        CSendTablePrecalc::CProxyPathEntry *pEntry = &pStack->m_pPrecalc->m_ProxyPathEntries[proxyPath.m_iFirstEntry +
                                                                                             i];
...
public:
    ...
    public:
        ...
        CallProxy(CClientDatatableStack *pStack, unsigned char *pStructBase, unsigned short iDatatableProp) {
...
public:
    ...
    public:
        static inline unsigned char *
        CallProxy(CServerDatatableStack *pStack, unsigned char *pStructBase, unsigned short iDatatableProp) {
