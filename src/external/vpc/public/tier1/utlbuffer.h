...
template<>
inline FMSTRRETTYPE GetFmtStr<short>(int nRadix, bool bPrint) {
    Assert(nRadix == 10);
    return "%hd";
}

template<>
inline FMSTRRETTYPE GetFmtStr<ushort>(int nRadix, bool bPrint) {
    Assert(nRadix == 10);
    return "%hu";
}

template<>
inline FMSTRRETTYPE GetFmtStr<int>(int nRadix, bool bPrint) {
    Assert(nRadix == 10);
    return "%d";
}

template<>
inline FMSTRRETTYPE GetFmtStr<uint>(int nRadix, bool bPrint) {
    Assert(nRadix == 10 || nRadix == 16);
    return nRadix == 16 ? "%x" : "%u";
}

template<>
inline FMSTRRETTYPE GetFmtStr<int64>(int nRadix, bool bPrint) {
    Assert(nRadix == 10);
    return "%lld";
}

template<>
inline FMSTRRETTYPE GetFmtStr<float>(int nRadix, bool bPrint) {
    Assert(nRadix == 10);
    return "%f";
}
