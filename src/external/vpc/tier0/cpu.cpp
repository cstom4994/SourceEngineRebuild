...
static bool cpuid(uint32 function, uint32 &out_eax, uint32 &out_ebx, uint32 &out_ecx, uint32 &out_edx) {
    ...
    __try
    {
        _asm
        {
            xoredx, edx        // Clue the compiler that EDX & others is about to be used.
                    xor ecx, ecx
                             xor
                             ebx, ebx        // <Sergiy> Note: if I don't zero these out, cpuid sometimes won't work, I didn't find out why yet
