...
static bool
InternalLookupHandleToThreadIDMap(HANDLE hThread, CThreadHandleToIDMap *&pMap, CThreadHandleToIDMap **&ppPrev) {
...
#ifdef PLATFORM_WINDOWS
    DWORD threadID;
    HANDLE hThread = (HANDLE) CreateThread(NULL, stackSize, ThreadProcConvert, new ThreadProcInfo_t(pfnThread, pParam),
                                           0, &threadID);
...
uint32
CThreadSyncObject::WaitForMultiple(int nObjects, CThreadSyncObject **ppObjects, bool bWaitAll, uint32 dwTimeout) {
#if defined( _WIN32 )
