...
FORCEINLINE void *
LMDRealloc(void *pMem, size_t nSize, size_t align = 0, const char *pszModule = NULL, int line = 0) { return NULL; }
...
int CStdMemAlloc::GetGenericMemoryStats(GenericMemoryStat_t **ppMemoryStats) {
...
#if !defined( MEMALLOC_REGIONS ) && defined( MEMALLOC_SEGMENT_MIXED )
    {
        ...
        size_t nLBHCurUsed = mspace_footprint(g_AllocRegions[0]), nLBHMaxUsed = mspace_max_footprint(
                g_AllocRegions[0]), nLBHArenaSize = infoLBH.arena, nLBHFree = infoLBH.fordblks;
