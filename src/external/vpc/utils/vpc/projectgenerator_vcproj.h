...
public:
    CCompilerTool(CVCProjGenerator *pGenerator, const char *pConfigName, bool bIsFileConfig) : CProjectTool(
            pGenerator) {
...
public:
    CCustomBuildTool(CVCProjGenerator *pGenerator, const char *pConfigName, bool bIsFileConfig) : CProjectTool(
            pGenerator) {
        m_ConfigName = pConfigName;
        m_bIsFileConfig = bIsFileConfig;
    }
...
public:
    ...
    void
    SetupGeneratorDefinition(IVCProjWriter *pVCProjWriter, const char *pDefinitionName, PropertyName_t *pPropertyNames);
