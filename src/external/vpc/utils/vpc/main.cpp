...
#else
            Log_Msg(LOG_VPC,
                    "[/srcctl]:     Enable P4SCC source control integration - can also set environment variable VPC_SRCCTL to 1\n");
#endif
...
void
CVPC::CreateOutputFilename(project_t *pProject, const char *pchPlatform, const char *pchPhase, const char *pGameName,
