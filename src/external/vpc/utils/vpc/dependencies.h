...
private:
    bool
    FindDependency_Internal(CUtlVector <CUtlBuffer> &callTreeOutputStack, CDependency *pTest, int flags, int depth);
...
public:
    ...
    void
    BuildProjectDependencies(int nBuildProjectDepsFlags, CUtlVector<CDependency_Project *> *pPhase1Projects = NULL);
    ...
    void
    GetProjectDependencyTree(projectIndex_t iProject, CUtlVector <projectIndex_t> &dependentProjects, bool bDownwards);
