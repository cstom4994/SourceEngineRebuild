...
public:
    ...
    virtual void
    OnLoadError(CefRefPtr <CefFrame> frame, int errorCode, const wchar_t *errorText, const wchar_t *failedUrl);
    ...
    CefRefPtr <JSObject>
    CreateFunction(const char *name, CefRefPtr <JSObject> object = NULL, bool bHasCallback = false);
    ...
    CefRefPtr <JSObject>
    InvokeWithResult(CefRefPtr <JSObject> object, const char *methodname, CefRefPtr <CefListValue> methodargs);
