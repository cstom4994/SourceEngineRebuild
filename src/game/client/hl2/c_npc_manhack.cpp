...
void C_NPC_Manhack::SoundInit(void) {
    ...
    if (!m_pEngineSound1) {
        m_pEngineSound1 = CSoundEnvelopeController::GetController().SoundCreate(filter, entindex(),
    ...
    if (!m_pEngineSound2) {
        m_pEngineSound2 = CSoundEnvelopeController::GetController().SoundCreate(filter, entindex(),
    ...
    if (!m_pBladeSound) {
        m_pBladeSound = CSoundEnvelopeController::GetController().SoundCreate(filter, entindex(),
