...
void C_CitadelEnergyCore::UpdateIdle(float percentage) {
    ...
    for (int i = 0; i < numParticles; i++) {
        ...
        sParticle = (SimpleParticle *) m_pAttractorEmitter->AddParticle(sizeof(SimpleParticle),
                                                                        m_pAttractorEmitter->GetPMaterial(
                                                                                "effects/strider_muzzle"), offset);
...
void C_CitadelEnergyCore::UpdateCharging(float percentage) {
    ...
    // Do the core effects
    for (int i = 0; i < 2; i++) {
        sParticle = (SimpleParticle *) m_pSimpleEmitter->AddParticle(sizeof(SimpleParticle),
                                                                     m_pSimpleEmitter->GetPMaterial(
                                                                             "effects/strider_muzzle"), GetAbsOrigin());
...
void C_CitadelEnergyCore::UpdateDischarging(void) {
    ...
    sParticle = (SimpleParticle *) m_pSimpleEmitter->AddParticle(sizeof(SimpleParticle), m_pSimpleEmitter->GetPMaterial(
            "effects/strider_muzzle"), GetAbsOrigin());
    ...
    for (int i = 0; i < 2; i++) {
        sParticle = (SimpleParticle *) m_pSimpleEmitter->AddParticle(sizeof(SimpleParticle),
                                                                     m_pSimpleEmitter->GetPMaterial(
                                                                             "effects/combinemuzzle2"), GetAbsOrigin());
    ...
    for (int i = 0; i < 4; i++) {
        ...
        sParticle = (SimpleParticle *) m_pAttractorEmitter->AddParticle(sizeof(SimpleParticle),
                                                                        m_pAttractorEmitter->GetPMaterial(
                                                                                "effects/combinemuzzle2_dark"), offset);
