        ...
        if ((dot1 > 0) != (dot2 > 0)) {
            ...
            for (iEdge = 0; iEdge < pSurf->m_nVerts; iEdge++) {
                ...
                edgePlane.m_Normal = pSurf->m_Plane.m_Normal.Cross(
                        pSurf->m_Verts[iEdge] - pSurf->m_Verts[(iEdge + 1) % pSurf->m_nVerts]);
...
#define MAX_SURFINFO_INTERSECTIONS    4
                ...
                if (nIntersections) {
                    ...
                    Vector reflection = direction -
                                        2 * DotProduct(direction, pIntersected[iIntersection]->m_Plane.m_Normal) *
                    ...
                    */
                    ...
                    AR2ExplosionParticle *pParticle =
                            (AR2ExplosionParticle *) m_ParticleEffect.AddParticle(sizeof(AR2ExplosionParticle),
                                                                                  m_MaterialHandle);
