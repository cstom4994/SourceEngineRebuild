...
public:
    ...
    virtual const MaterialSystem_Config_t &
    GetCurrentConfigForVideoCard() const { return m_pBaseMaterialsPassThru->GetCurrentConfigForVideoCard(); }
    ...
    GetVideoCardIdentifier(void) const { return m_pBaseMaterialsPassThru->GetVideoCardIdentifier(); }
    ...
    GetMaterialProxyFactory() { return m_pBaseMaterialsPassThru->GetMaterialProxyFactory(); }
    ...
    virtual ITexture *FindTexture(char const *pTextureName, const char *pTextureGroupName, bool complain = true,
        ...
        return m_pBaseMaterialsPassThru->FindTexture(pTextureName, pTextureGroupName, complain,
    ...
    virtual ITexture *CreateNamedRenderTargetTextureEx(
        ...
        return m_pBaseMaterialsPassThru->CreateNamedRenderTargetTextureEx(pRTName, w, h, sizeMode, format, depth,
    ...
    virtual ITexture *CreateNamedRenderTargetTexture(const char *pRTName,
        ...
        return m_pBaseMaterialsPassThru->CreateNamedRenderTargetTexture(pRTName, w, h, sizeMode, format, depth,
                                                                        bClampTexCoords, bAutoMipMap);
    }
    ...
    virtual ITexture *CreateNamedRenderTargetTextureEx2(
            ...
            unsigned int textureFlags = TEXTUREFLAGS_CLAMPS | TEXTUREFLAGS_CLAMPT,
            unsigned int renderTargetFlags = 0) {
        return m_pBaseMaterialsPassThru->CreateNamedRenderTargetTextureEx2(pRTName, w, h, sizeMode, format, depth,
                                                                           textureFlags, renderTargetFlags);
    }
    ...
    virtual void UpdateLightmap(int lightmapPageID, int lightmapSize[2],
        ...
        m_pBaseMaterialsPassThru->UpdateLightmap(lightmapPageID, lightmapSize, offsetIntoLightmapPage, pFloatImage,
    ...
    virtual IMatRenderContext *
    CreateRenderContext(MaterialContextType_t type) { return m_pBaseMaterialsPassThru->CreateRenderContext(type); }

    virtual IMatRenderContext *
    SetRenderContext(IMatRenderContext *c) { return m_pBaseMaterialsPassThru->SetRenderContext(c); }
    ...
    virtual IMaterial *
    FindProceduralMaterial(const char *pMaterialName, const char *pTextureGroupName, KeyValues *pVMTKeyValues) {
    ...
    virtual ImageFormat
    GetShadowDepthTextureFormat() { return m_pBaseMaterialsPassThru->GetShadowDepthTextureFormat(); }
    ...
    FindMaterialEx(char const *pMaterialName, const char *pTextureGroupName, int nContext, bool complain = true,
                   const char *pComplainPrefix = NULL) {
        return m_pBaseMaterialsPassThru->FindMaterialEx(pMaterialName, pTextureGroupName, nContext, complain,
                                                        pComplainPrefix);
    }
    ...
    virtual void
    OverrideRenderTargetAllocation(bool rtAlloc) { m_pBaseMaterialsPassThru->OverrideRenderTargetAllocation(rtAlloc); }

    virtual ITextureCompositor *
    NewTextureCompositor(int w, int h, const char *pCompositeName, int nTeamNum, uint64 randomSeed,
                         KeyValues *stageDesc, uint32 texCompositeCreateFlags = 0) {
        return m_pBaseMaterialsPassThru->NewTextureCompositor(w, h, pCompositeName, nTeamNum, randomSeed, stageDesc,
                                                              texCompositeCreateFlags);
    }
    ...
    AsyncFindTexture(const char *pFilename, const char *pTextureGroupName, IAsyncTextureOperationReceiver *pRecipient,
        ...
        m_pBaseMaterialsPassThru->AsyncFindTexture(pFilename, pTextureGroupName, pRecipient, pExtraArgs, bComplain,
                                                   nAdditionalCreationFlags);
    }
    ...
    CreateNamedTextureFromBitsEx(const char *pName, const char *pTextureGroupName, int w, int h, int mips,
        ...
        return m_pBaseMaterialsPassThru->CreateNamedTextureFromBitsEx(pName, pTextureGroupName, w, h, mips, fmt,
                                                                      srcBufferSize, srcBits, nFlags);
    }
...
public:
    IMaterial *
    FindMaterialEx(char const *pMaterialName, const char *pTextureGroupName, int nContext, bool complain = true,
                   const char *pComplainPrefix = NULL) OVERRIDE {
        return ReplaceMaterialInternal(
                BaseClass::FindMaterialEx(pMaterialName, pTextureGroupName, nContext, complain, pComplainPrefix));
    }

    IMaterial *FindMaterial(char const *pMaterialName, const char *pTextureGroupName, bool complain = true,
                            const char *pComplainPrefix = NULL) OVERRIDE {
        return ReplaceMaterialInternal(
                BaseClass::FindMaterial(pMaterialName, pTextureGroupName, complain, pComplainPrefix));
    }

    IMaterial *
    FindProceduralMaterial(const char *pMaterialName, const char *pTextureGroupName, KeyValues *pVMTKeyValues) OVERRIDE;
    ...
    AddTextureCompositorTemplate(const char *pName, KeyValues *pTmplDesc,
                                 int nTexCompositeTemplateFlags = 0) OVERRIDE { return false; };

    // Performs final verification of all compositor templates (after they've all been initially loaded).
    bool VerifyTextureCompositorTemplates() OVERRIDE { return false; };
