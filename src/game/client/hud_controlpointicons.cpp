...
// Purpose: 
//-----------------------------------------------------------------------------
CControlPointIcon::CControlPointIcon(Panel *parent, const char *pName, int iIndex) : vgui::EditablePanel(parent,
                                                                                                         "ControlPointIcon"),
                                                                                     CHudElement(pName) {
...
// Purpose: 
//-----------------------------------------------------------------------------
CHudControlPointIcons::CHudControlPointIcons(const char *pName) : vgui::Panel(NULL, "HudControlPointIcons"),
                                                                  CHudElement(pName) {
...
//========================================================================================================================
CControlPointProgressBar::CControlPointProgressBar(Panel *parent) : vgui::EditablePanel(parent,
...
void CControlPointProgressBar::SetupForPoint(CControlPointIcon *pIcon) {
    ...
    if (m_pAttachedToIcon && !bInWinState) {
        ...
        if (!bCapBlocked && iCappingTeam != TEAM_UNASSIGNED && iCappingTeam != iOwnerTeam &&
