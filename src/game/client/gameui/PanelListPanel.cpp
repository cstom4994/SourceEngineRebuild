...
VScrollBarReversedButtons::VScrollBarReversedButtons(Panel *parent, const char *panelName, bool vertical) : ScrollBar(
        parent, panelName, vertical) {
}
...
// Output : 
//-----------------------------------------------------------------------------
CPanelListPanel::CPanelListPanel(vgui::Panel *parent, char const *panelName, bool inverseButtons) : Panel(parent,
                                                                                                          panelName) {
