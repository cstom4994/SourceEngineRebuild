...
void CCommentaryModelViewer::HandleMovementInput(void) {
    ...
    if (m_flYawSpeed != 0) {
        if (m_bTranslating) {
            m_pModelPanel->m_pModelInfo->m_vecOriginOffset.y = clamp(
                    m_pModelPanel->m_pModelInfo->m_vecOriginOffset.y + m_flYawSpeed, -100.f, 100.f);
        } else {
    ...
    if (m_flZoomSpeed != 0) {
        if (m_bTranslating) {
            m_pModelPanel->m_pModelInfo->m_vecOriginOffset.z = clamp(
                    m_pModelPanel->m_pModelInfo->m_vecOriginOffset.z + m_flZoomSpeed, -100.f, 300.f);
        } else {
            ...
            m_pModelPanel->m_pModelInfo->m_vecOriginOffset.x = clamp(
                    m_pModelPanel->m_pModelInfo->m_vecOriginOffset.x + m_flZoomSpeed, flZoomMin, flZoomMax);
        }
