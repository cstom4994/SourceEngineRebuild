...
void CHudDeathNotice::Paint() {
    ...
    for (int i = 0; i < MAX_DEATHNOTICES; i++) {
        ...
        rgDeathNoticeList[i].flDisplayTime = MIN(rgDeathNoticeList[i].flDisplayTime,
...
void CHudDeathNotice::FireGameEvent(KeyValues *event) {
    ...
    if (i == MAX_DEATHNOTICES) { // move the rest of the list forward to make room for this item
