...
ConVar deferred_rt_shadowspot_res("deferred_rt_shadowspot_res", "1024",
                                  FCVAR_HIDDEN | FCVAR_RELOAD_TEXTURES | FCVAR_RELOAD_MATERIALS);
...
#endif
ConVar deferred_rt_shadowpoint_res("deferred_rt_shadowpoint_res", "1024",
                                   FCVAR_HIDDEN | FCVAR_RELOAD_TEXTURES | FCVAR_RELOAD_MATERIALS);
#if DEFCFG_ADAPTIVE_SHADOWMAP_LOD
...
void OnCookieTableChanged(void *object, INetworkStringTable *stringTable, int stringNumber, const char *newString,
                          void const *newData) {
