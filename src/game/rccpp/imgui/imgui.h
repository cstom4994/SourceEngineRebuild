...
namespace ImGui {
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/engine/cppcore/imgui/issues/3361
...
struct ImFont {
    ...
    IMGUI_API void
    AddGlyph(ImFontConfig *src_cfg, ImWchar c, float x0, float y0, float x1, float y1, float u0, float v0, float u1,
...
//
// See Glossary https://github.com/ocornut/engine/cppcore/imgui/wiki/Glossary for details about some of the terminology.
// See Thread https://github.com/ocornut/engine/cppcore/imgui/issues/1542 for gifs, news and questions about this evolving feature.
//
