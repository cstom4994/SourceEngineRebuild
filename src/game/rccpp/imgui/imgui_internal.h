...
enum ImGuiItemFlags_ {
    ...
    ImGuiItemFlags_Disabled = 1
            << 2,  // false    // [BETA] Disable interactions but doesn't affect visuals yet. See github.com/ocornut/engine/cppcore/imgui/issues/211
...
enum ImGuiTabItemFlagsPrivate_ {
    ...
    1 << 21,  // [Docking] Trailing tabs with the _Unsorted flag will be sorted based on the DockOrder of their Window.
