    ...
    void MainLoop() override {
        ...
        ImGui::Begin("RCC++ Developer Tools");
        {
            ...
            if (ImGui::IsItemHovered())
                ImGui::SetTooltip("Compilation is triggered by saving a runtime compiled file.");
            ...
            if (ImGui::IsItemHovered())
                ImGui::SetTooltip(
                        "RCCPPOPTIMIZATIONLEVEL_DEBUG in DEBUG, RCCPPOPTIMIZATIONLEVEL_PERF in RELEASE.\nThis is the default state.");
            ...
            if (ImGui::IsItemHovered())
                ImGui::SetTooltip(
                        "No optimization set in compile, soeither underlying compiler default or set through SetAdditionalCompileOptions.");
            ...
            if (ImGui::IsItemHovered()) ImGui::SetTooltip("Undo the last save.");
            ImGui::SameLine();
            ...
            if (g_pSys->power_save) {
                ImGui::TextWrapped(
                        "Animated features may stop moving when Power Save is ON and no input is detected; for example Dear ImGui Demo, Plots Widgets");
            } else {
