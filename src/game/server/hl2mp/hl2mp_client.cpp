...
void Host_Say(edict_t * pEdict, bool
teamonly );
...
void ClientActive(edict_t * pEdict, bool
bLoadGame )
{
...
void respawn(CBaseEntity * pEdict, bool
fCopyCorpse )
{
