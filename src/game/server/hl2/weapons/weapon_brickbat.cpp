...
DEFINE_KEYFIELD( m_iCurrentAmmoType, FIELD_INTEGER,
"BrickbatType" ),
...
void CWeaponBrickbat::ThrowBrickbat(Vector vecSrc, Vector vecVelocity, float damage) {
    CGrenade_Brickbat *pBrickbat = (CGrenade_Brickbat *) Create(BrickBatAmmoArray[m_iCurrentAmmoType].m_sClassName,
                                                                vecSrc, vec3_angle, GetOwner());
