...
public:
    ...
    TurretUse( CBaseEntity
    *pActivator,
    CBaseEntity *pCaller, USE_TYPE
    useType,
    float value
    );
    ...
    SpinDownCall(void) { m_iSpin = 0; }

    virtual void EXPORT

    SpinUpCall(void) { m_iSpin = 1; }
...
//KEYFIELDS
DEFINE_KEYFIELD( m_flMaxWait, FIELD_FLOAT,
"maxsleep" ),
DEFINE_KEYFIELD( m_iOrientation, FIELD_INTEGER,
"orientation" ),
DEFINE_KEYFIELD( m_iSearchSpeed, FIELD_INTEGER,
"searchspeed" ),
DEFINE_KEYFIELD( m_iBaseTurnRate, FIELD_INTEGER,
"turnrate" ),
