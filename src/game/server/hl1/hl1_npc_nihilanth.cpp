...
DEFINE_ARRAY( m_hSphere, FIELD_EHANDLE,
N_SPHERES ),
...
DEFINE_ARRAY( m_szRechargerTarget, FIELD_CHARACTER,
64 ),
DEFINE_ARRAY( m_szDrawUse, FIELD_CHARACTER,
64 ),
DEFINE_ARRAY( m_szTeleportUse, FIELD_CHARACTER,
64 ),
DEFINE_ARRAY( m_szTeleportTouch, FIELD_CHARACTER,
64 ),
DEFINE_ARRAY( m_szDeadUse, FIELD_CHARACTER,
64 ),
DEFINE_ARRAY( m_szDeadTouch, FIELD_CHARACTER,
64 ),
DEFINE_FIELD( m_flShootEnd, FIELD_TIME
),
DEFINE_FIELD( m_flShootTime, FIELD_TIME
),
DEFINE_ARRAY( m_hFriend, FIELD_EHANDLE,
3 ),
...
void CNPC_Nihilanth::Flight(void) {
    ...
    QAngle vAngle = QAngle(GetAbsAngles().x + m_avelocity.x, GetAbsAngles().y + m_avelocity.y,
...
void
CNihilanthHVR::TeleportInit(CNPC_Nihilanth *pOwner, CBaseEntity *pEnemy, CBaseEntity *pTarget, CBaseEntity *pTouch) {
    SetMoveType(MOVETYPE_FLY);
    SetSolid(SOLID_BBOX);
