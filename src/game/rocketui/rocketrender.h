...
public:
    ...
    void
    RenderGeometry(Rml::Vertex *vertices, int num_vertices, int *indices, int num_indices, Rml::TextureHandle texture,
    ...
    CompileGeometry(Rml::Vertex *vertices, int num_vertices, int *indices, int num_indices,
    ...
    virtual bool GenerateTexture(Rml::TextureHandle &texture_handle, const Rml::byte *source,
