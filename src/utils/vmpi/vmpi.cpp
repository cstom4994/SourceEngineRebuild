...
public:
    ...
    void HandleDisconnect() {
        if (m_pSocket) {
            ...
            // Tell the app.
            FOR_EACH_LL(g_DisconnectHandlers, i) g_DisconnectHandlers[i](m_iConnection, str);
...
public:
    ...
    bool
    Init(int argc, char **argv, const char *pDependencyFilename, int nMaxWorkers, VMPIRunMode runMode, bool bPatchMode);
