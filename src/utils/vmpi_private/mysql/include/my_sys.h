...
extern my_bool NEAR
mysys_uses_curses , my_use_symdir;
extern long lCurMemory, lMaxMemory;    /* from safemalloc */

extern ulong my_default_record_cache_size;
extern my_bool NEAR
my_disable_locking , NEAR my_disable_async_io,
        NEAR
my_disable_flush_key_blocks , NEAR my_disable_symlinks;
...
enum cache_type {
    READ_CACHE, WRITE_CACHE, READ_FIFO, READ_NET, WRITE_NET
};
enum flush_type {
    FLUSH_KEEP, FLUSH_RELEASE, FLUSH_IGNORE_CHANGED,
    FLUSH_FORCE_WRITE
};
...
enum file_type {
    UNOPEN = 0, FILE_BY_OPEN, FILE_BY_CREATE,
...
extern int my_message(uint
my_err , const char *str, myf
MyFlags ) ;
extern int my_message_no_curses(uint
my_err , const char *str, myf
MyFlags ) ;
extern int my_message_curses(uint
my_err , const char *str, myf
MyFlags ) ;
