...
/* ################################################################### */
    ...
    public:
        ...
        inline void add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, ezOptionValidator *validator = 0);

        inline void add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, std::string_view flag2, ezOptionValidator *validator = 0);

        inline void add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, std::string_view flag2, std::string_view flag3,
                        ezOptionValidator *validator = 0);

        inline void add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, std::string_view flag2, std::string_view flag3, std::string_view flag4,
                        ezOptionValidator *validator = 0);
...
/* ################################################################### */
    void
    ezOptionParser::add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, ezOptionValidator *validator) {
...
/* ################################################################### */
    void
    ezOptionParser::add(std::string_view defaults, bool required, int expectArgs, char delim, std::string_view help,
                        std::string_view flag1, std::string_view flag2, ezOptionValidator *validator) {
        size_t id = this->groups.size();
        OptionGroup *g = new OptionGroup;
        g->defaults = defaults;
        g->isRequired = required;
