...
namespace termcolor {
    ...
    public:
        style &reset(bool o = true) {
            _reset = o ? 1 : 0;
            return *this;
        }

        style &bold(bool o = true) {
            _bold = o ? 1 : 0;
            return *this;
        }

        style &dark(bool o = true) {
            _dark = o ? 1 : 0;
            return *this;
        }

        style &underline(bool o = true) {
            _underline = o ? 1 : 0;
            return *this;
        }

        style &blink(bool o = true) {
            _blink = o ? 1 : 0;
            return *this;
        }

        style &reverse(bool o = true) {
            _reverse = o ? 1 : 0;
            return *this;
        }

        style &concealed(bool o = true) {
            _concealed = o ? 1 : 0;
            return *this;
        }
    ...
    public:
        style &grey() {
            _colors.named.foreground = color_grey;
            _foreground_type = color_type_named;
            return *this;
        }

        style &red() {
            _colors.named.foreground = color_red;
            _foreground_type = color_type_named;
            return *this;
        }

        style &green() {
            _colors.named.foreground = color_green;
            _foreground_type = color_type_named;
            return *this;
        }

        style &yellow() {
            _colors.named.foreground = color_yellow;
            _foreground_type = color_type_named;
            return *this;
        }

        style &blue() {
            _colors.named.foreground = color_blue;
            _foreground_type = color_type_named;
            return *this;
        }

        style &magenta() {
            _colors.named.foreground = color_magenta;
            _foreground_type = color_type_named;
            return *this;
        }

        style &cyan() {
            _colors.named.foreground = color_cyan;
            _foreground_type = color_type_named;
            return *this;
        }

        style &white() {
            _colors.named.foreground = color_white;
            _foreground_type = color_type_named;
            return *this;
        }

        style &on_grey() {
            _colors.named.background = color_grey;
            _background_type = color_type_named;
            return *this;
        }

        style &on_red() {
            _colors.named.background = color_red;
            _background_type = color_type_named;
            return *this;
        }

        style &on_green() {
            _colors.named.background = color_green;
            _background_type = color_type_named;
            return *this;
        }

        style &on_yellow() {
            _colors.named.background = color_yellow;
            _background_type = color_type_named;
            return *this;
        }

        style &on_blue() {
            _colors.named.background = color_blue;
            _background_type = color_type_named;
            return *this;
        }

        style &on_magenta() {
            _colors.named.background = color_magenta;
            _background_type = color_type_named;
            return *this;
        }

        style &on_cyan() {
            _colors.named.background = color_cyan;
            _background_type = color_type_named;
            return *this;
        }

        style &on_white() {
            _colors.named.background = color_white;
            _background_type = color_type_named;
            return *this;
        }

        style &color(std::uint8_t i) {
            _colors.index.foreground = i;
            _foreground_type = color_type_indexed;
            return *this;
        }

        style &on_color(std::uint8_t i) {
            _colors.index.background = i;
            _background_type = color_type_indexed;
            return *this;
        }
    ...
    std::ostream &operator<<(std::ostream &stream, const style &style_) {
        ...
        switch (style_._foreground_type) {
            ...
            case style::color_type_rgb:
                stream << color
                        (style_._colors.rgb.foreground_red, style_._colors.rgb.foreground_green,
        ...
        switch (style_._background_type) {
            ...
            case style::color_type_rgb:
                stream << on_color
                        (style_._colors.rgb.background_red, style_._colors.rgb.background_green,
