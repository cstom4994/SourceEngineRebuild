...
static void PopulateSoundNameList(mxListBox *pListBox) {
    ...
    if (g_pSoundEmitterBase) {
        for (int i = g_pSoundEmitterBase->First();
             i != g_pSoundEmitterBase->InvalidIndex(); i = g_pSoundEmitterBase->Next(i)) {
...
void CBoneControlWindow::Init() {
    ...
    mxButton *btnApplyChild = new mxButton(this, left, top + 115, 140, 20, "Apply to Children",
    ...
    m_cAutoHitbox = new mxCheckBox(this, left, top + 140, 140, 20, "Autogenerate Hitboxes",
    ...
    m_cShowDefaultPose = new mxCheckBox(this, left, top + 160, 140, 20, "Show Default Pose",
    ...
    m_cHitboxHighlight = new mxCheckBox(this, left + 3, top + 45, 100, 20, "Highlight Hitbox",
...
void ControlPanel::SetupSequenceWindow(mxTab *pTab) {
    ...
    for (int i = 0; i < MAX_SEQUENCES; i++) {
        ...
        rbFrameSelection[i] = new mxRadioButton(wSequence, 300, 5 + i * 22, 35, 22, "", IDC_FRAMESELECTION0 + i,
                                                i == 0);
    }
