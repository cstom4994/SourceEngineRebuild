...
private:
    ...
    void
    UnserializeElementAttribute(CUtlBuffer &buf, CDmxAttribute *pAttribute, CUtlVector<CDmxElement *> &elementList);

    void UnserializeElementArrayAttribute(CUtlBuffer &buf, CDmxAttribute *pAttribute,
                                          CUtlVector<CDmxElement *> &elementList);

    bool
    UnserializeAttributes(CUtlBuffer &buf, CDmxElement *pElement, CUtlVector<CDmxElement *> &elementList, int nStrings,
                          int *offsetTable, char *stringTable);
...
//-----------------------------------------------------------------------------
bool
CDmxSerializer::SaveElement(CUtlBuffer &buf, CDmxSerializationDictionary &list, CUtlRBTree<const char *> &stringTable,
                            CDmxElement *pElement) {
...
//-----------------------------------------------------------------------------
bool
CDmxSerializer::UnserializeAttributes(CUtlBuffer &buf, CDmxElement *pElement, CUtlVector<CDmxElement *> &elementList,
...
bool SerializeDMX(CUtlBuffer &buf, CDmxElement *pRoot, const char *pFileName) {
    ...
    int nEncodingVersion = buf.IsText() ? 1
