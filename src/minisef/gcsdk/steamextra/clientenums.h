...
enum EAccountFlags {
    ...
    k_EAccountFlagPersonaNameSet = (1
            << 0),    // true if the user has set the persona name they really want, instead of the auto-generated one
    ...
    k_EAccountFlagMarketingTreatment = (1
            << 15),        // account is flagged as being in a treatment for marketing/sales experiments
};
