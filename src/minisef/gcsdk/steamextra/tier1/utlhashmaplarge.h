...
private:
    enum EInsertPolicy {
        eInsert_UpdateExisting, eInsert_LeaveExisting, eInsert_CreateDupes
    };
...
inline int
CUtlHashMapLarge<K, T, L, H>::InsertInternal(const KeyType_t &key, const ElemType_t &insert, EInsertPolicy ePolicy) {
