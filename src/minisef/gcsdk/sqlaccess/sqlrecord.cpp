        ...
        *pnVal = 0;
        ...
        if (bRet) {
            switch (m_pResultSet->GetColumnType(unColumn)) {
                ...
                default:
                    AssertMsg1(false, "GetIntValue tried to catch a %s, which is the wrong type",
    ...
    bool CSQLRecord::BGetFloatValue(uint32 unColumn, float *pfVal) {
        ...
        *pfVal = 0.0f;
        ...
        if (bRet) {
            ...
            AssertMsg2(sizeof(float) == cubData, "GetValue expected %llu bytes, found %d", (uint64) sizeof(float),
                       cubData);
    ...
    bool CSQLRecord::BGetDoubleValue(uint32 unColumn, double *pdVal) {
        ...
        *pdVal = 0.0f;
        ...
        if (bRet) {
            ...
            AssertMsg2(sizeof(double) == cubData, "GetValue expected %llu bytes, found %d", (uint64) sizeof(double),
                       cubData);
