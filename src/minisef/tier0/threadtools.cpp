...
bool CStdThreadEvent::Set() {
    ...
    if (!m_bSignaled.compare_exchange_strong(expected, true, std::memory_order::memory_order_release,
...
template<class ScopeLockable>
static bool WaitForEventsAny(int nEvents, CStdThreadEvent *const *pEvents, unsigned timeout, int &iEventIndex,
                             ScopeLockable &lock) {
    bool bRet = true;
        ...
        } else if (timeout != 0) // We still haven't timed out, so let's wait
        {
            ...
            if (!bRet) {
                switch (nEvents) {
                    ...
                    case 5: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 6: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex, pEvents[5]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 7: {
                    ...
                    case 8: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex, pEvents[5]->m_Mutex,
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 9: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex, pEvents[5]->m_Mutex,
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex, pEvents[8]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 10: {
                    ...
                    case 11: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex, pEvents[5]->m_Mutex,
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex, pEvents[8]->m_Mutex,
                                                 pEvents[9]->m_Mutex, pEvents[10]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 12: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 pEvents[3]->m_Mutex, pEvents[4]->m_Mutex, pEvents[5]->m_Mutex,
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex, pEvents[8]->m_Mutex,
                                                 pEvents[9]->m_Mutex, pEvents[10]->m_Mutex, pEvents[11]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 13: {
                    ...
                    case 14: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 ...
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex, pEvents[8]->m_Mutex,
                                                 pEvents[9]->m_Mutex, pEvents[10]->m_Mutex, pEvents[11]->m_Mutex,
                                                 pEvents[12]->m_Mutex, pEvents[13]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    case 15: {
                        CExtendedScopedLock lock(pEvents[0]->m_Mutex, pEvents[1]->m_Mutex, pEvents[2]->m_Mutex,
                                                 ...
                                                 pEvents[6]->m_Mutex, pEvents[7]->m_Mutex, pEvents[8]->m_Mutex,
                                                 pEvents[9]->m_Mutex, pEvents[10]->m_Mutex, pEvents[11]->m_Mutex,
                                                 pEvents[12]->m_Mutex, pEvents[13]->m_Mutex, pEvents[14]->m_Mutex);
                        bRet = WaitForEventsAll(nEvents, pEvents, timeout, lock);
                        break;
                    }
                    default: {
...
int
CWorkerThread::CallWorker(unsigned dw, unsigned timeout, bool fBoostWorkerPriorityToMaster, CFunctor *pParamFunctor) {
