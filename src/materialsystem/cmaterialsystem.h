...
public:
    ...
    GetFullbrightBumpedLightmapTextureHandle() const { return m_FullbrightBumpedLightmapTextureHandle; }
    ...
    ShaderAPITextureHandle_t
    GetLinearToGammaIdentityTableTextureHandle() const { return m_LinearToGammaIdentityTableTextureHandle; }
    ...
    AsyncFindTexture(const char *pFilename, const char *pTextureGroupName, IAsyncTextureOperationReceiver *pRecipient,
                     void *pExtraArgs, bool bComplain = true, int nAdditionalCreationFlags = 0) OVERRIDE;
    ...
    virtual bool
    AddTextureCompositorTemplate(const char *pName, KeyValues *pTmplDesc, int nTexCompositeTemplateFlags = 0) OVERRIDE;
    ...
    ShaderAPITextureHandle_t
    GetShaderAPITextureBindHandle(ITexture *pTexture, int nFrame, int nTextureChannel); // JasonM ????
