...
DEFINE_FALLBACK_SHADER( PP_PortalRefract, PP_PortalRefract_dx9 )
BEGIN_VS_SHADER(PP_PortalRefract_dx9, "PortalRefract" )
	BEGIN_SHADER_PARAMS
	...
	void SetupVarsPortalRefract( PortalRefractVars_t &info )
	{
		...
		info.m_nPortalTintEnabled = PORTALTINTENABLED;
		info.m_nPortalTintColor = PORTALTINTCOLOR;
		info.m_nTime = TIME;
	}
