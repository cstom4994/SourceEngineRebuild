...
//	virtual void				RenderZOnlyWithHeightClip( bool bEnable ) = 0;
    ...
    virtual void
    CopyRenderTargetToTextureEx(ITexture *pTexture, int nRenderTargetID, Rect_t *pSrcRect, Rect_t *pDstRect = NULL) {
    }

    virtual void
    CopyTextureToRenderTargetEx(int nRenderTargetID, ITexture *pTexture, Rect_t *pSrcRect, Rect_t *pDstRect = NULL) {
    }
    ...
    virtual int
    CompareMaterialCombos(IMaterial *pMaterial1, IMaterial *pMaterial2, int lightmapID1, int lightmapID2) { return 0; }
...
// ------------ New Vertex/Index Buffer interface ----------------------------
    ...
    CreateStaticIndexBuffer(MaterialIndexFormat_t fmt, int nIndexCount, const char *pBudgetGroup) {
        Assert(0);
        return NULL;
    }
...
// ------------ End ----------------------------
    ...
    NewTextureCompositor(int w, int h, const char *pCompositeName, int nTeamNum, uint64 randomSeed,
                         KeyValues *stageDesc, uint texCompositeCreateFlags) OVERRIDE {
        return NULL;
    }
    ...
    virtual bool
    AddTextureCompositorTemplate(const char *pName, KeyValues *pTmplDesc, int nTexCompositeTemplateFlags) OVERRIDE {
        return false;
    }
