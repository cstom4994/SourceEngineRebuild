...
#include "../engine/components/vgui2/src/vgui_key_translation.h"
...
class HTMLPopup : public vgui::Frame {
    ...
    public:
        PopupHTML(Frame *parent, const char *pchName, bool allowJavaScript, bool bPopupWindow) : HTML(parent, pchName,
                                                                                                      allowJavaScript,
                                                                                                      bPopupWindow) { m_pParent = parent; }
...
HTML::HTML(Panel *parent, const char *name, bool allowJavaScript, bool bPopupWindow) : Panel(parent, name),
                                                                                       m_NeedsPaint(this,
                                                                                                    &HTML::BrowserNeedsPaint),
                                                                                       m_StartRequest(this,
                                                                                                      &HTML::BrowserStartRequest),
                                                                                       m_URLChanged(this,
                                                                                                    &HTML::BrowserURLChanged),
                                                                                       m_FinishedRequest(this,
                                                                                                         &HTML::BrowserFinishedRequest),
                                                                                       m_LinkInNewTab(this,
                                                                                                      &HTML::BrowserOpenNewTab),
                                                                                       m_ChangeTitle(this,
                                                                                                     &HTML::BrowserSetHTMLTitle),
                                                                                       m_NewWindow(this,
                                                                                                   &HTML::BrowserPopupHTMLWindow),
                                                                                       m_FileLoadDialog(this,
                                                                                                        &HTML::BrowserFileLoadDialog),
                                                                                       m_SearchResults(this,
                                                                                                       &HTML::BrowserSearchResults),
                                                                                       m_CloseBrowser(this,
                                                                                                      &HTML::BrowserClose),
                                                                                       m_HorizScroll(this,
                                                                                                     &HTML::BrowserHorizontalScrollBarSizeResponse),
                                                                                       m_VertScroll(this,
                                                                                                    &HTML::BrowserVerticalScrollBarSizeResponse),
                                                                                       m_LinkAtPosResp(this,
                                                                                                       &HTML::BrowserLinkAtPositionResponse),
                                                                                       m_JSAlert(this,
                                                                                                 &HTML::BrowserJSAlert),
                                                                                       m_JSConfirm(this,
                                                                                                   &HTML::BrowserJSConfirm),
                                                                                       m_CanGoBackForward(this,
                                                                                                          &HTML::BrowserCanGoBackandForward),
                                                                                       m_SetCursor(this,
                                                                                                   &HTML::BrowserSetCursor),
                                                                                       m_StatusText(this,
                                                                                                    &HTML::BrowserStatusText),
                                                                                       m_ShowTooltip(this,
                                                                                                     &HTML::BrowserShowToolTip),
                                                                                       m_UpdateTooltip(this,
                                                                                                       &HTML::BrowserUpdateToolTip),
                                                                                       m_HideTooltip(this,
                                                                                                     &HTML::BrowserHideToolTip) {
    m_iHTMLTextureID = 0;
    m_bCanGoBack = false;
    ...
    if (m_SteamAPIContext.SteamHTMLSurface()) {
        ...
        SteamAPICall_t hSteamAPICall = m_SteamAPIContext.SteamHTMLSurface()->CreateBrowser(
    ...
    m_iCopyLinkMenuItemID = m_pContextMenu->AddMenuItem("#vgui_HTMLCopyLink",
                                                        new KeyValues("Command", "command", "copylink"), this);
    ...
    m_pContextMenu->AddSeparator();
    m_nViewSourceAllowedIndex = m_pContextMenu->AddMenuItem("#vgui_HTMLViewSource",
                                                            new KeyValues("Command", "command", "viewsource"), this);
}
