...
static int
AddItemToTree(TreeView *tv, const char *label, int parentIndex, const Color &fg, int groupNumber, int handle) {
...
void CBaseAnimSetControlGroupPanel::ChangeAnimationSet(CDmeAnimationSet *newAnimSet) {
    ...
    if (bRebuildGroups) {
        ...
        // Create root
        int rootIndex = AddItemToTree(m_hGroups, "root", -1, Color(128, 128, 128, 255), -1,
