...
static int
__cdecl PeakSortFunc(vgui::ListPanel *pPanel, const vgui::ListPanelItem &item1, const vgui::ListPanelItem &item2) {
...
void CDmeCombinationControlsPanel::OnImportCombination() {
    ...
    vgui::FileOpenDialog *pDialog = new vgui::FileOpenDialog(this, "Select File to Import", true,
                                                             new KeyValues("ImportControls"));
...
void CDmeCombinationDominationRulesPanel::SelectRule(CDmeCombinationDominationRule *pRule) {
    for (int nItemID = m_pDominationRulesList->FirstItem();
         nItemID != m_pDominationRulesList->InvalidItemID(); nItemID = m_pDominationRulesList->NextItem(nItemID)) {
        KeyValues *pKeyValues = m_pDominationRulesList->GetItem(nItemID);
...
// Constructor, destructor
//-----------------------------------------------------------------------------
CDmeCombinationSystemEditorPanel::CDmeCombinationSystemEditorPanel(vgui::Panel *pParent, const char *pName) : BaseClass(
        pParent, pName) {
