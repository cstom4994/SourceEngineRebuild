...
//-----------------------------------------------------------------------------
void
CMatSystemSurface::DrawSetTextureFile(int id, const char *pFileName, int hardwareFilter, bool forceReload /*= false*/) {
...
bool CMatSystemSurface::AddCustomFontFile(const char *fontName, const char *fontFileName) {
    ...
    if (gdiModule) {
        ...
        AddFontResourceExProc pAddFontResourceEx = (AddFontResourceExProc) ::GetProcAddress(gdiModule,
                                                                                            "AddFontResourceExA");
...
//-----------------------------------------------------------------------------
void
CMatSystemSurface::DrawPrintText(const wchar_t *text, int iTextLen, FontDrawType_t drawType /*= FONT_DRAW_DEFAULT */ ) {
    MAT_FUNC;
...
void CMatSystemSurface::RestrictPaintToSinglePanel(VPANEL panel) {
    ...
    if (!input()->GetAppModalSurface()) {
        input()->SetAppModalSurface(
                panel);    // if painting is restricted to this panel, it had better be modal, or else you can get in some bad state...
    }
}
...
int
CMatSystemSurface::DrawColoredText(vgui::HFont font, int x, int y, int r, int g, int b, int a, const char *fmt, ...) {
    MAT_FUNC;
...
void
CMatSystemSurface::DrawSetTextureRGBAEx(int id, const unsigned char *rgba, int wide, int tall, ImageFormat format) {
...
void
CMatSystemSurface::DrawUpdateRegionTextureRGBA(int nTextureID, int x, int y, const unsigned char *pchData, int wide,
...
//-----------------------------------------------------------------------------
void
CMatSystemSurface::GetFullscreenViewportAndRenderTarget(int &x, int &y, int &w, int &h, ITexture **ppRenderTarget) {
