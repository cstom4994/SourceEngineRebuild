...
static inline void
Intersect(const vgui::Vertex_t &start, const vgui::Vertex_t &end, vgui::Vertex_t *pOut, Clipper &clipper) {
    ...
    if (g_bScissor) {
        ...
        if (!g_bStretchTexture) {
            pOutUL->m_TexCoord.x = InterpTCoord(pOutUL->m_Position.x,
                                                inUL.m_Position.x, inLR.m_Position.x, inUL.m_TexCoord.x,
                                                inLR.m_TexCoord.x);
            ...
            pOutUL->m_TexCoord.y = InterpTCoord(pOutUL->m_Position.y,
                                                inUL.m_Position.y, inLR.m_Position.y, inUL.m_TexCoord.y,
                                                inLR.m_TexCoord.y);
