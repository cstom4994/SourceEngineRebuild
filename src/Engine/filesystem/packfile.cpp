...
//-----------------------------------------------------------------------------
void
CZipPackFile::GetFileAndDirLists(const char *pRawWildCard, CUtlStringList &outDirnames, CUtlStringList &outFilenames,
                                 bool bSortedOutput) {
...
void CZipPackFile::SetupPreloadData() {
    ...
    m_pPreloadRemapTable = (unsigned short *) ((byte *) m_pPreloadDirectory +
