...
void
CStudioRender::R_GatherStats(studiomeshgroup_t *pGroup, CMeshBuilder &MeshBuilder, IMesh *pMesh, IMaterial *pMaterial) {
    int nCount = 0;
    ...
    for (int j = 0; j < pGroup->m_NumStrips; ++j) {
        ...
        for (int i = 0; i < pStrip->numIndices; i += 3) {
            ...
            float flTriArea = TriangleArea(*(const Vector *) (pPos1), *(const Vector *) (pPos2),
                                           *(const Vector *) (pPos3));
