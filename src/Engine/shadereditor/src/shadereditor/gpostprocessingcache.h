...
public:
    ...
    EditorPostProcessingEffect(CUtlVector<CHLSL_SolverBase *> &hSolvers, GenericPPEData &config,
                               bool bCopySolvers = true);
...
public:
    ...
    static void RenderSinglePPE(EditorPostProcessingEffect *effect, bool bPreviewMode = false, bool bSceneMode = false,
