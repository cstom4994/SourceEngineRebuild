...
void CNodeCustom::WriteJackDataFromKV(KeyValues *pKV, CUtlVector<__funcParamSetup *> &m_hIn,
                                      CUtlVector<__funcParamSetup *> &m_hOut,
...
void CNodeCustom::FillJackDataFromKV(KeyValues *pKV, CUtlVector<__funcParamSetup *> &m_hIn,
                                     CUtlVector<__funcParamSetup *> &m_hOut) {
