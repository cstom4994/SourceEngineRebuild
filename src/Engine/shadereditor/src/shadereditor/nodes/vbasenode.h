...
private:
    virtual int
    GetHierachyTypeIterateFullyRecursive_Internal(CUtlVector<CBaseNode *> &m_hNodesProcessed, int *iAllowances = NULL);
...
private:
    ...
    void Recursive_AddTailNodes_Internal(CUtlVector<CBaseNode *> &m_hProcessedNodes,
                                         ...
                                         bool bHierachyUp, bool bOnlyWithoutSolver, CBaseContainerNode *pContainer,
                                         bool bAddContainers);
...
public:
    ...
    void Recursive_AddTailNodes(CUtlVector<CBaseNode *> &m_hList, bool bHierachyUp,
                                bool bOnlyWithoutSolver = false, CBaseContainerNode *pContainer = NULL,
                                bool bAddContainers = false);
