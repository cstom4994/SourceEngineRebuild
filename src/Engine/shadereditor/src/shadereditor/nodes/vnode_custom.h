...
public:
    ...
    static void
    WriteJackDataFromKV(KeyValues *pKV, CUtlVector<__funcParamSetup *> &m_hIn, CUtlVector<__funcParamSetup *> &m_hOut,
                        int maxIn, int maxOut);

    static void
    FillJackDataFromKV(KeyValues *pKV, CUtlVector<__funcParamSetup *> &m_hIn, CUtlVector<__funcParamSetup *> &m_hOut);
