...
public:
    ...
    CNodeBaseEvaluate(const char *name, CNodeView *p, int LockOutput, int numInputs = 1, bool bSmall = false,
                      int LockInput = -1);
    ...
    virtual int GetNodeType() {
        Assert(0);
        return HLSLNODE_MATH_NORMALIZE;
    };
...
CREATE_EVALUATE_NODE_FAST_SETIN_SMALL_LOCKIN(Distance, HLSLNODE_VECTOR_DISTANCE, HLSLVAR_FLOAT1, 2,
