...
CCode_Editor::CCode_Editor(CSheet_Base *parent, const char *pName, CSmartText::CodeEditMode_t mode) : BaseClass(parent,
                                                                                                                pName) {
    m_iMode = mode;
...
void CCode_Editor::InitHlsl(const char *pszFunctionName, CUtlVector<__funcParamSetup *> *input,
                            CUtlVector<__funcParamSetup *> *output,
