...
public:
    ...
    CCode_Editor(CSheet_Base *parent, const char *pName,
                 CSmartText::CodeEditMode_t mode = CSmartText::CODEEDITMODE_HLSL);

    ~CCode_Editor();

    void InitHlsl(const char *pszFunctionName = NULL, CUtlVector<__funcParamSetup *> *input = NULL,
                  CUtlVector<__funcParamSetup *> *output = NULL,
