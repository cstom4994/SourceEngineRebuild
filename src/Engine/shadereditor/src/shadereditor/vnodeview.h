...
public:
    ...
    static int
    CreatePPSolversFromFile(const char *fileName, CUtlVector<CHLSL_SolverBase *> &hOutput, GenericPPEData &config);
...
private:
    ...
    void
    PasteNodes(KeyValues *pKV, bool bAutoSelect, Vector2D *origin = NULL, CUtlVector<CBaseNode *> *m_hNewNodes = NULL);
