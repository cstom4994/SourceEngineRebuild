...
void CHLSL_Solver_Parallax::OnWriteFXC(bool bIsPixelShader, WriteContext_FXC &context) {
    ...
    int iCurJack = 0;
    CHLSL_Var *var_uv = GetSourceVar(iCurJack);
    iCurJack++;
    CHLSL_Var *var_viewts = GetSourceVar(iCurJack);
    iCurJack++;
    CHLSL_Var *var_prlxamt = GetSourceVar(iCurJack);
    iCurJack++;
    ...
    CHLSL_Var *var_wnormal = GetSourceVar(iCurJack);
    iCurJack++;
    CHLSL_Var *var_eyedir = GetSourceVar(iCurJack);
    iCurJack++;
    CHLSL_Var *var_sampler_heightmap = GetSourceVar(iCurJack);
    iCurJack++;
