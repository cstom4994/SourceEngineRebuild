...
ColorPicker::ColorPicker(vgui::Panel *parent, const char *pElementName, Panel *pActionsignalTarget) : BaseClass(parent,
                                                                                                                pElementName) {
    pTarget = NULL;
...
ColorPicker::ColorPicker(vgui::Panel *parent, const char *pElementName, TextEntry *pTargetEntry) : BaseClass(parent,
                                                                                                             pElementName) {
