...
//-----------------------------------------------------------------------------
static int
__cdecl OperationSortFunc(vgui::ListPanel *pPanel, const vgui::ListPanelItem &item1, const vgui::ListPanelItem &item2) {
    ...
    switch (m_Action) {
        ...
        case PERFORCE_ACTION_FILE_SUBMIT: {
            ...
            if (!pDescription[0] || !Q_stricmp(pDescription, "<enter description here>")) {
                vgui::MessageBox *pError = new vgui::MessageBox("Submission Error!",
                                                                "Description required for submission.", GetParent());
...
//-----------------------------------------------------------------------------
void
ShowPerforceQuery(vgui::Panel *pParent, const char *pFileName, vgui::Panel *pActionSignalTarget, KeyValues *pKeyValues,
