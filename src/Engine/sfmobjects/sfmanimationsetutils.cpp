...
static CDmeChannelsClip *CreateChannelsClip(CDmeAnimationSet *pAnimationSet, CDmeFilmClip *pOwnerClip) {
    ...
    CDmeChannelsClip *pChannelsClip = CreateElement<CDmeChannelsClip>(pAnimationSet->GetName(),
                                                                      pAnimationSet->GetFileId());
...
template<class T>
CDmeChannel *
CreateConstantValuedLog(CDmeChannelsClip *channelsClip, const char *basename, const char *pName, CDmElement *pToElement,
...
//-----------------------------------------------------------------------------
static void
CreateTransformChannels(CDmeTransform *pTransform, const char *pBaseName, int bi, CDmeChannelsClip *pChannelsClip) {
    char name[256];
...
static void SetupRootTransform(CDmeFilmClip *shot, CDmeChannelsClip *srcChannelsClip,
                               CDmeChannelsClip *channelsClip, CDmElement *control, CDmeGameModel *gameModel,
                               const char *basename, bool bAttachToGameRecording) {
...
void
LoadDefaultGroupMappings(CUtlDict<CUtlString, int> &defaultGroupMapping, CUtlVector<CUtlString> &defaultGroupOrdering) {
...
CDmElement *
FindOrAddDefaultGroupForControls(const char *pGroupName, CDmaElementArray<CDmElement> &groups, DmFileId_t fileid) {
...
CDmeAnimationSet *CreateAnimationSet(CDmeFilmClip *pMovie, CDmeFilmClip *pShot,
                                     CDmeGameModel *pGameModel, const char *pAnimationSetName, int nSequenceToUse,
