...
public:
    ...
    const class IVP_U_Point_4 *
    get_inv_masses() { return (class IVP_U_Point_4 *) &inv_rot_inertia; } // combined solution for inertias
...
public:
     ...
     *	section:	constructor
     ********************************************************************************/
    IVP_Core(IVP_Real_Object *object, const IVP_U_Quat *q_world_f_object_init, const IVP_U_Point *position,
             IVP_BOOL physical_unmoveable_, IVP_BOOL enable_piling_optimization);
    ...
    void
    update_exact_mindist_events_of_core();// sets mindist_event_already_done and recalculates exact mindist events to all objects with flag not set
    ...
    ********************************************************************************/
    ...
    inline void clip_velocity(IVP_U_Float_Point *velocity,
                              IVP_U_Float_Point *angular_velocity); // parameters are input and output !!!

    inline void calc_next_PSI_matrix(IVP_U_Vector<IVP_Core> *cores_which_needs_calc_next_psi,
                                     class IVP_Event_Sim *) { // call commit_all_calc_next_PSI_matrix afterwards
    ...
    void get_surface_speed_on_test(const IVP_U_Float_Point *position_cs_in, const IVP_U_Float_Point *center_speed_in,
    ...
    static void get_diff_surface_speed_of_two_cores_on_test(const IVP_Core *core_A, const IVP_Core *core_B,
                                                            const IVP_U_Float_Point *position_A_cs,
                                                            const IVP_U_Float_Point *position_B_cs,
                                                            const IVP_U_Float_Point *speed_A,
                                                            const IVP_U_Float_Point *rot_speed_A,
                                                            const IVP_U_Float_Point *speed_B,
     ...
     ********************************************************************************/
    void push_core(const IVP_U_Float_Point *position_cs_in, const IVP_U_Float_Point *impulse_cs_in,
                   const IVP_U_Float_Point *impulse_ws_in);

    // very fast, but needs redundant input values
    void async_push_core(const IVP_U_Float_Point *position_cs_in, const IVP_U_Float_Point *impulse_cs_in,
                         const IVP_U_Float_Point *impulse_ws_in);

    void test_push_core(const IVP_U_Float_Point *position_cs_in, const IVP_U_Float_Point *impulse_cs_in,
                        const IVP_U_Float_Point *impulse_ws_in,
    ...
    void test_rot_push_core_multiple_cs(const IVP_U_Float_Point *angular_impulse_cs, IVP_DOUBLE factor,
    ...
    ********************************************************************************/
     ...
     ********************************************************************************/
    IVP_DOUBLE calc_correct_virt_mass(const IVP_U_Float_Point *position_cs, const IVP_U_Float_Point *direction_core,
    ...
    IVP_DOUBLE calc_virt_mass(const IVP_U_Float_Point *core_point,
                              const IVP_U_Float_Point *direction) const;    // calc the virtual mass of a point
     ...
     *******************************************************************************************/
    void
    calc_at_matrix(IVP_Time current_time, IVP_U_Matrix *m_world_f_core_out) const;        // calc a matrix at any time
