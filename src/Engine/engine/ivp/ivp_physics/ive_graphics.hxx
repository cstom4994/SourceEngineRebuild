...
extern int p_mousepointer_raycast(P_Hardware *hardware, IVP_Environment *environment, IVP_U_Matrix *camera,
                                  IVP_U_Point *ray_direction, IVP_Ray_Solver_Min_Hash **raysolver_minhash,
...
extern int p_graphlib_convert_directx_object_to_concave_data(P_Hardware *hw, const char *filename,
                                                             IVP_Concave_Polyhedron *concave_polyhedron);

extern int p_graphlib_robust_convert_directx_object_to_compact_ledges(P_Hardware *hw, const char *filename,
...
public:
    ...
    void show_worldpoint(const IVP_U_Point &cameraposition, const IVP_U_Point &worldpoint,
