...
void
IVP_Anomaly_Manager::max_velocity_exceeded(IVP_Anomaly_Limits *al, IVP_Core *, IVP_U_Float_Point *velocity_in_out) {
...
void IVP_Anomaly_Manager::max_angular_velocity_exceeded(IVP_Anomaly_Limits *al, IVP_Core *core,
...
void IVP_Anomaly_Manager::inter_penetration(IVP_Mindist *mindist, IVP_Real_Object *obj0, IVP_Real_Object *obj1,
    ...
    for (int i = 0; i < my_compact_ledge->get_n_triangles(); i++) {
        ...
        IVP_DOUBLE distance = hesse_plane.get_dist(
                &obj_pos_moving); //negative distance means surface is looking away from me (backside)
