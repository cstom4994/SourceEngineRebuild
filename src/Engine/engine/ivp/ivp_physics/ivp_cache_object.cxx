...
void
IVP_Cache_Object::transform_position_to_object_coords(const IVP_U_Point *P_world, IVP_U_Point *P_object_out) const {
    this->m_world_f_object.inline_vimult4(P_world, P_object_out);
}

void IVP_Cache_Object::transform_position_to_object_coords(const IVP_U_Point *P_world,
                                                           IVP_U_Float_Point *P_object_out) const {
    this->m_world_f_object.inline_vimult4(P_world, P_object_out);
}

void IVP_Cache_Object::transform_position_to_world_coords(const IVP_U_Float_Point *P_object,
...
void IVP_Cache_Object::transform_vector_to_object_coords(const IVP_U_Float_Point *P_world,
                                                         IVP_U_Float_Point *P_object_out) const {
    this->m_world_f_object.inline_vimult3(P_world, P_object_out);
}
...
void IVP_Cache_Object::transform_vector_to_world_coords(const IVP_U_Float_Point *P_object,
