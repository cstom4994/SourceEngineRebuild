...
public:
    ...
    inline IVP_FLOAT
    get_max_angular_velocity_per_psi() const { return max_angular_velocity_per_psi; }; // [radians/psi]**2
...
public:
    ...
    virtual void
    max_angular_velocity_exceeded(IVP_Anomaly_Limits *, IVP_Core *, IVP_U_Float_Point *angular_velocity_in_out);
    ...
    void
    solve_inter_penetration_simple(IVP_Real_Object *, IVP_Real_Object *); //push mass centers in opposite directions
