...
class hk_VecFPU {
public:
    static inline void fpu_add_multiple_row(hk_real *target_adress, hk_real *source_adress, hk_real factor, int size,
    ...
    static inline void
    fpu_exchange_rows(hk_real *target_adress1, hk_real *target_adress2, int size, hk_bool adress_aligned);
    ...
    static inline void
    fpu_add_multiple_row(hk_double *target_adress, hk_double *source_adress, hk_double factor, int size,
                         hk_bool adress_aligned);

    static inline void fpu_multiply_row(hk_double *target_adress, hk_double factor, int size, hk_bool adress_aligned);

    static inline void
    fpu_exchange_rows(hk_double *target_adress1, hk_double *target_adress2, int size, hk_bool adress_aligned);

    static inline void
    fpu_copy_rows(hk_double *target_adress, hk_double *source_adress, int size, hk_bool adress_aligned);
