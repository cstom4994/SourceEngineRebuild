...
public:
    ...
    hk_Constraint(hk_Local_Constraint_System *sys, hk_Rigid_Body *a, hk_Rigid_Body *b,
                  hk_effector_priority redundend_prio, int redundant_storage_size);
    ...
    get_constraint_system() // returns the constraint system, if the constraint is used in a system mode
    {
