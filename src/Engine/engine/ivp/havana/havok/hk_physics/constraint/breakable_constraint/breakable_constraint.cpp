...
int hk_Breakable_Constraint::setup_and_step_constraint(hk_PSI_Info &pi, void *mem, hk_real tau_factor,
                                                       hk_real damp_factor) {
    /*
    ...
    m_is_broken =
            ss0.breaks(m_linear_strength, m_angular_strength) || ss1.breaks(m_linear_strength, m_angular_strength);
