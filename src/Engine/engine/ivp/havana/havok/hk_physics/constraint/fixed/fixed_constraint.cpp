...
hk_Fixed_Constraint::hk_Fixed_Constraint(hk_Local_Constraint_System *constraint_system, const hk_Fixed_BP *bp,
...
// setup and step
int hk_Fixed_Constraint::setup_and_step_constraint(hk_PSI_Info &pi, void *mem, hk_real tau_factor,
    ...
    hk_Fixed_Dense_Vector<6> delta;
    {
        ...
        delta.set_mul_add_mul(m_tau * tau_factor, work.m_correction, -1.0f * m_strength * strength_factor,
                              vmq_velocity);
    }
