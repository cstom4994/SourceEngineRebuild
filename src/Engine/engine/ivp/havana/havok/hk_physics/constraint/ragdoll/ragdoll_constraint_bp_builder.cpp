...
hk_result hk_Ragdoll_Constraint_BP_Builder::initialize_from_limited_ball_socket_bp(const hk_Limited_Ball_Socket_BP *bp,
    ...
    switch (number_of_freedom) {
        ...
        case 3: {
            { // first search the axis with the lowest rot inertia, which is should be used for the twist axis in Aos
                ...
                pos_Ref_ws.set_transformed_pos(t0, r.m_transform_os_ks[0].get_translation());
                hk_Vector3 pos_Att_ws;
                pos_Att_ws.set_transformed_pos(t1, r.m_transform_os_ks[1].get_translation());
                ...
                r.m_limits[HK_LIMIT_TWIST].set_limits(bp->m_angular_limits[axis_of_min_inertia].m_min,
                ...
                r.m_limits[HK_LIMIT_PLANES].set_limits(bp->m_angular_limits[l_axis].m_min,
