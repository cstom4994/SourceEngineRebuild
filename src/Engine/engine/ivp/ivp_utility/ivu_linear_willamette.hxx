...
inline void IVP_U_Float_Point::inline_subtract_and_mult(const IVP_U_Point *v1, const IVP_U_Point *v2,
...
inline void
IVP_U_Point::add_multiple(const IVP_U_Point *v1, const IVP_U_Point *v2, IVP_DOUBLE factor2) {    // vektor addition
    IVP_DOUBLE a, b, c;
...
inline void IVP_U_Point::add_multiple(const IVP_U_Point *v1, const IVP_U_Float_Point *v2,
...
inline void IVP_U_Point::inline_subtract_and_mult(const IVP_U_Point *v1, const IVP_U_Point *v2,
                                                  IVP_DOUBLE factor) {    // vektor addition
    IVP_DOUBLE a, b, c;
    a = (v1->k[0] - v2->k[0]);
    b = (v1->k[1] - v2->k[1]);
...
inline void IVP_U_Point::inline_subtract_and_mult(const IVP_U_Float_Point *v1, const IVP_U_Float_Point *v2,
                                                  IVP_DOUBLE factor) {    // vektor addition
    IVP_DOUBLE a, b, c;
    a = (v1->k[0] - v2->k[0]);
    b = (v1->k[1] - v2->k[1]);
...
void IVP_U_Point::inline_set_vert_to_area_defined_by_three_points(const IVP_U_Point *tp0, const IVP_U_Point *tp1,
...
void
IVP_U_Point::inline_set_vert_to_area_defined_by_three_points(const IVP_U_Float_Point *tp0, const IVP_U_Float_Point *tp1,
                                                             const IVP_U_Point *tp2) {
    IVP_DOUBLE a0, a1, a2, b0, b1, b2;
    // calculate (not-normized) normal
    IVP_DOUBLE fp0 = tp0->k[0];
