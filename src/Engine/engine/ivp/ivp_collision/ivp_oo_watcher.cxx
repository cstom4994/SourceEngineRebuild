...
void IVP_OO_Watcher::hull_limit_exceeded_event() {
    ...
    env->get_mindist_manager()->create_exact_mindists(obj0, obj1, dist0 + dist1, &mindists, NULL, NULL, NULL, NULL,
                                                      this);
...
IVP_OO_Watcher::IVP_OO_Watcher(IVP_Collision_Delegator *del, IVP_Real_Object *obj0, IVP_Real_Object *obj1)
