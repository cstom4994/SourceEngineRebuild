...
void IVP_Car_System_Real_Wheels::do_steering(IVP_FLOAT s_angle, bool bAnalog) {
    ...
    car_body->get_core()->rot_speed_change.k[IVP_COORDINATE_INDEX(cs_car->y_idx)] -=
...
IVP_Car_System_Real_Wheels::IVP_Car_System_Real_Wheels(IVP_Environment *env, IVP_Template_Car_System *templ) {
    ...
    ////////    CONSTRAINT SYSTEM    //////////////////////////////////
    ///////////////////////////////////////////////////////////////////
    this->car_constraint_solver = new IVP_Constraint_Solver_Car(templ->index_x, templ->index_y, templ->index_z,
                                                                templ->is_left_handed);
...
//    wheel_core->rot_speed = car_body->get_core()->rot_speed;
    ...
    car_constraint_solver->wheel_objects.element_at(
            wheel_nr)->fix_wheel_constraint = this->fix_wheel_constraint[wheel_nr];
}
...
void IVP_Car_System_Real_Wheels::set_booster_acceleration(IVP_FLOAT acceleration) {
    if (acceleration) {
        ...
        if (!booster_actuator[0]) {
            ...
            forceTempUp.force =
                    -1.0f * pCarBody->get_core()->get_mass() * environment->get_gravity()->k[pCarConstraint->y_idx];
