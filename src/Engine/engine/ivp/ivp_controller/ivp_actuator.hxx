...
public:
    ...
    virtual void check_dist_is_going_to_be_deleted_event(
            IVP_Actuator_Check_Dist *) = 0;    // has to remove itself from IVP_Actuator_Check_Dist
};
...
public:
    ...
    void init_anchor_check_dist(IVP_Real_Object *object, IVP_U_Point *position_world_space,
...
public:
    ...
    IVP_U_Point *
    get_float_cam_props(IVP_DOUBLE *fc_height_out, IVP_DOUBLE *fc_target_height_out, IVP_DOUBLE *fc_dist_out,
