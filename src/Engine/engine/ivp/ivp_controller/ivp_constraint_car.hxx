...
public:
    ...
    // Constructor/Deconstructor
    IVP_Constraint_Solver_Car(IVP_COORDINATE_INDEX right, IVP_COORDINATE_INDEX up, IVP_COORDINATE_INDEX forward,
    ...
    IVP_RETURN_TYPE
    init_constraint_system(IVP_Environment *env, IVP_Real_Object *body, IVP_U_Vector<IVP_Real_Object> &wheels,
    ...
    int
    get_num_of_appending_terminals() { return wheel_objects.len(); };            // e.g. 4 for four wheels, might be more flexible in the future
