...
void CEngineVGui::Init() {
    ...
    m_hStaticGameUIModule = g_pFileSystem->LoadModule(szDllName, "GAMEBIN",
...
static void
VGui_RecursePanel(CUtlVector<vgui::VPANEL> &panelList, int x, int y, vgui::VPANEL check, bool include_hidden) {
