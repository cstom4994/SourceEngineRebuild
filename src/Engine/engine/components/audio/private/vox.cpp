...
#include "utlsymbol.h"
#include "utldict.h"
#include "../src/MapReslistGenerator.h"
...
void
VOX_LookupRangeHeadingOrGrid(int irhg, char *pGroupName, channel_t *pChannel, SoundSource soundsource, char **ppszNew,
                             char **ppszNew1, char **ppszNew2, int *pcnew, bool fsimple) {
...
// return number of words loaded
void
VOX_TouchSound(const char *pszin, CUtlDict<int, int> &filelist, CUtlRBTree<ccpair, int> &ccpairs, bool spewsentences) {
#ifndef SWDS
    char buffer[512];
    int i, cword;
    char pathbuffer[MAX_PATH];
