...
//-----------------------------------------------------------------------------
void
BuildGroup::LoadControlSettings(const char *controlResourceName, const char *pathID, KeyValues *pPreloadedKeyValues,
            ...
            for (; pCondition != NULL; pCondition = pCondition->GetNextKey()) {
                ...
                if (pConditionBlock) {
                    ...
                    for (pOverridingKey = pConditionBlock->GetFirstSubKey();
                         pOverridingKey != NULL; pOverridingKey = pOverridingKey->GetNextKey()) {
