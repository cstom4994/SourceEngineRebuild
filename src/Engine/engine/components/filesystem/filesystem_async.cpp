...
//-----------------------------------------------------------------------------
FSAsyncStatus_t
CBaseFileSystem::AsyncReadMultiple(const FileAsyncRequest_t *pRequests, int nRequests, FSAsyncControl_t *phControls) {
...
//-----------------------------------------------------------------------------
FSAsyncStatus_t
CBaseFileSystem::AsyncReadMultipleCreditAlloc(const FileAsyncRequest_t *pRequests, int nRequests, const char *pszFile,
...
//-----------------------------------------------------------------------------
FSAsyncStatus_t
CBaseFileSystem::AsyncWrite(const char *pFileName, const void *pSrc, int nSrcBytes, bool bFreeMemory, bool bAppend,
...
//-----------------------------------------------------------------------------
FSAsyncStatus_t
CBaseFileSystem::AsyncWriteFile(const char *pFileName, const CUtlBuffer *pBuff, int nSrcBytes, bool bFreeMemory,
...
FSAsyncStatus_t CBaseFileSystem::SyncRead(const FileAsyncRequest_t &request) {
    ...
    AsyncOpenedFile_t *pHeldFile = (request.hSpecificAsyncFile != FS_INVALID_ASYNC_FILE) ? g_AsyncOpenedFiles.Get(
            request.hSpecificAsyncFile) : NULL;
...
//-----------------------------------------------------------------------------
FSAsyncStatus_t
CBaseFileSystem::SyncWrite(const char *pszFilename, const void *pSrc, int nSrcBytes, bool bFreeMemory, bool bAppend) {
