...
void CVPhysicsVirtualMeshWriter::UnpackCompactLedgeFromHull(IVP_Compact_Ledge *pLedge, int materialIndex,
    ...
    pLedge->set_size(sizeof(IVP_Compact_Ledge) + sizeof(IVP_Compact_Triangle) *
...
static void
InitTriangle(IVP_Compact_Triangle *pTri, int index, int materialIndex, int v0, int v1, int v2, int opp0, int opp1,
             int opp2) {
...
virtualmeshhull_t *
CVPhysicsVirtualMeshWriter::CreatePackedHullFromLedges(const virtualmeshlist_t &list, const IVP_Compact_Ledge **pLedges,
                                                       int ledgeCount) {
    int triCount = 0;
    int edgeCount = 0;
    ...
    unsigned int totalSize =
            sizeof(packedtriangle_t) * triCount + sizeof(packededge_t) * edgeCount + sizeof(packedhull_t) * ledgeCount +
            sizeof(virtualmeshhull_t);
