...
public:
    ...
    virtual IVP_DOUBLE get_elasticity(
            IVP_Contact_Situation *situation)        // range [0, 1.0f[, the relative speed after a collision compared to the speed before
    {
...
// Global pointer to singleton for engine.dll internal access
...
IVP_Material *
CIVPMaterialManager::get_material_by_index(IVP_Real_Object *pObject, const IVP_U_Point *world_position, int index) {
