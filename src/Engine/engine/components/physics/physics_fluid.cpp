...
CreateFluidController(IVP_Environment *pEnvironment, CPhysicsObject *pFluidObject, fluidparams_t *pParams) {
    ...
    IVP_Liquid_Surface_Descriptor *lsd = new CLiquidSurfaceDescriptor(pFluidObject, pParams->surfacePlane,
                                                                      pParams->currentVelocity);
    ...
    // -------------------------------------------------------------------------------
    CBuoyancyAttacher *attacher_to_cores_buoyancy = new CBuoyancyAttacher(buoyancy_input,
                                                                          pPhantom->get_intruding_cores(), lsd);
