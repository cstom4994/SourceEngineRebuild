...
public:
    ...
    virtual bool
    GetMorphAccumulatorTexCoord(IMorphMgrRenderContext *pRenderContext, Vector2D *pTexCoord, IMorph *pMorph,
                                int nVertex);
...
void CMorph::CreateStaticMesh() {
    ...
    m_pMorphBuffer = pRenderContext->CreateStaticMesh(vertexFormat, TEXTURE_GROUP_MORPH_TARGETS,
                                                      m_MorphAccumulationMaterial);
...
void CMorphMgr::AllocateScratchTextures() {
    ...
    m_pMorphAccumTexture = TextureManager()->CreateRenderTargetTexture("_rt_MorphAccumulator",
                                                                       m_nAccumulatorWidth * nMultFactor,
                                                                       m_nAccumulatorHeight * nMultFactor,
    ...
    if (!m_bUsingConstantRegisters) {
        m_pMorphWeightTexture = TextureManager()->CreateRenderTargetTexture("_rt_MorphWeight",
                                                                            m_nWeightWidth * nMultFactor,
                                                                            m_nWeightHeight * nMultFactor,
                                                                            RT_SIZE_OFFSCREEN, fmt,
...
//-----------------------------------------------------------------------------
void
CMorphMgr::ComputeAccumulatorSubrect(int *pXOffset, int *pYOffset, int *pWidth, int *pHeight, int nMorphAccumBlockId) {
    *pXOffset = nMorphAccumBlockId / m_nSubrectVerticalCount;
    *pYOffset = nMorphAccumBlockId - m_nSubrectVerticalCount * (*pXOffset);
