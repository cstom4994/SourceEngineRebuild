...
//-----------------------------------------------------------------------------
KeyValues *
CShaderDeviceMgrBase::FindDXLevelAndVendorSpecificConfig(KeyValues *pKeyValues, int nDxLevel, int nVendorID) {
    if (IsX360()) {
...
void CShaderDeviceMgrBase::LoadHardwareCaps(KeyValues *pGroup, HardwareCaps_t &caps) {
    ...
    caps.m_bDisableShaderOptimizations = ReadBool(pGroup, "DisableShaderOptimizations",
