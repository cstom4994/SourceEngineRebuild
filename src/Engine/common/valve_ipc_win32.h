...
VALVE_IPC_IMPL BOOL CValveIpcMgr::UnregisterServer(RPC_CSTR
szServerUID )
{
...
UUID uuid;
if ( RPC_S_OK !=
UuidFromString( szServerUID, &uuid
))
return
FALSE;
...
VALVE_IPC_IMPL DWORD WINAPI
CValveIpcServer::RunDelegate( LPVOID
lpvParam )
{
return reinterpret_cast< CValveIpcServer * >( lpvParam )->
...
VALVE_IPC_IMPL BOOL CValveIpcClient::ExecuteCommand(LPVOID
bufIn,
DWORD numInBytes, LPVOID
bufOut,
DWORD &numOutBytes
)
{
