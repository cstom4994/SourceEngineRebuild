...
#include "bitbuf.h"
#include "const.h"
#include "../engine/src/net_chan.h"
#include "mathlib/mathlib.h"
#include "networkstringtabledefs.h"
#include "../engine/src/event_system.h"
#include "../engine/src/dt.h"
...
const char *SVC_PacketEntities::ToString(void) const {
    Q_snprintf(s_text, sizeof(s_text), "%s: delta %i, max %i, changed %i,%s bytes %i",
               GetName(), m_nDeltaFrom, m_nMaxEntries, m_nUpdatedEntries, m_bUpdateBaseline ? " BL update," : "",
               Bits2Bytes(m_nLength));
    return s_text;
}
