...
namespace {
    ...
    public:
        ...
        YouTubeUploadHandle_t
        Upload(const char *pFilePath, const char *pMimeType, const char *pTitle, const char *pDescription,
               const char *pCategory, const char *pKeywords, eYouTubeAccessControl access);
...
private:
    ...
    virtual JobStatus_t DoExecute() {
        HTTPRequestHandle hRequest = GetISteamHTTP()->CreateHTTPRequest(k_EHTTPMethodGET,
...
private:
    ...
    virtual JobStatus_t DoExecute() {
        ...
        HTTPRequestHandle hRequest = GetISteamHTTP()->CreateHTTPRequest(k_EHTTPMethodPOST,
...
public:
    CYouTubeUploadJob(CYouTubeSystem *pSystem, const char *pFilePath, const char *pMimeType, const char *pTitle,
            ...
            : CYouTubeJob(pSystem), m_strFilePath(pFilePath), m_strMimeType(pMimeType), m_strTitle(pTitle),
              m_strDesc(pDescription), m_strCategory(pCategory), m_strKeywords(pKeywords), m_eAccess(access) {
    }
...
private:
    ...
    virtual JobStatus_t DoExecute() {
        ...
        HTTPRequestHandle hRequest = GetISteamHTTP()->CreateHTTPRequest(k_EHTTPMethodPUT,
...
CYouTubeSystem::CYouTubeSystem()
        : m_eLoginStatus(kYouTubeLogin_NotLoggedIn), m_pThreadPool(NULL),
...
YouTubeUploadHandle_t
CYouTubeSystem::Upload(const char *pFilePath, const char *pMimeType, const char *pTitle, const char *pDescription,
                       const char *pCategory, const char *pKeywords, eYouTubeAccessControl access) {
    if (m_eLoginStatus != kYouTubeLogin_LoggedIn) {
        return NULL;
    }
    CYouTubeUploadJob *pJob = new CYouTubeUploadJob(this, pFilePath, pMimeType, pTitle, pDescription, pCategory,
                                                    pKeywords, access);
    AddJobToThreadPool(pJob);
...
YouTubeUploadHandle_t
YouTube_Upload(const char *pFilePath, const char *pMimeType, const char *pTitle, const char *pDescription,
               const char *pCategory, const char *pKeywords, eYouTubeAccessControl access) {
