...
void C_BaseExplosionEffect::CreateDebris(void) {
    ...
    for (i = 0; i < numSparks; i++) {
        tParticle = (TrailParticle *) pSparkEmitter->AddParticle(sizeof(TrailParticle), m_Material_FireCloud,
                                                                 m_vecOrigin);
    ...
    for (i = 0; i < numFlecks; i++) {
        ...
        FleckParticle *pParticle = (FleckParticle *) fleckEmitter->AddParticle(sizeof(FleckParticle),
                                                                               g_Mat_Fleck_Cement[random->RandomInt(0,
                                                                                                                    1)],
                                                                               offset);
...
void C_WaterExplosionEffect::CreateDebris(void) {
    ...
    for (i = 0; i < 16; i++) {
        ...
        pParticle = (SimpleParticle *) pSimple->AddParticle(sizeof(SimpleParticle), pMaterial[random->RandomInt(0, 1)],
                                                            offset);
