...
static CCBasePanelBasePanel *g_pBasePanel = NULL;
...
//-----------------------------------------------------------------------------
CCBasePanelBasePanel *BasePanel() {
    return g_pBasePanel;
}
...
static CBackgroundMenuButton *CreateMenuButton(CCBasePanelBasePanel *parent, const char *panelName, const wchar_t *panelText) {
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CCBasePanelBasePanel::CCBasePanelBasePanel() : Panel(NULL, "BaseGameUIPanel") {
    g_pBasePanel = this;
...
//-----------------------------------------------------------------------------
KeyValues *CCBasePanelBasePanel::GetConsoleControlSettings(void) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ArmFirstMenuItem(void) {
    UpdateGameMenus();
...
CCBasePanelBasePanel::~CCBasePanelBasePanel() {
    g_pBasePanel = NULL;
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::PaintBackground() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::UpdateBackgroundState() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::SetBackgroundRenderState(EBackgroundState state) {
...
void CCBasePanelBasePanel::StartExitingProcess() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnSizeChanged(int newWide, int newTall) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnLevelLoadingStarted() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnLevelLoadingFinished() {
    m_bLevelLoading = false;
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::DrawBackgroundImage() {
...
void CCBasePanelBasePanel::CheckBonusBlinkState() {
#ifdef _X360
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::UpdateGameMenus() {
...
//-----------------------------------------------------------------------------
CGameMenu *CCBasePanelBasePanel::RecursiveLoadGameMenu(KeyValues *datafile) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunFrame() {
    InvalidateLayout();
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::UpdateRichPresenceInfo() {
#if defined( _X360 )
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::PerformLayout() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ApplySchemeSettings(IScheme *pScheme) {
    int i;
    BaseClass::ApplySchemeSettings(pScheme);
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnActivateModule(int moduleIndex) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnGameUIActivated() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunMenuCommand(const char *command) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::QueueCommand(const char *pCommand) {
    if (m_bXUIVisible) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunQueuedCommands() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ClearQueuedCommands() {
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::IsPromptableCommand(const char *command) {
    // Blech!
...
static unsigned PanelJobWrapperFn(void *pvContext) {
    CCBasePanelBasePanel::CAsyncJobContext *pAsync = reinterpret_cast< CCBasePanelBasePanel::CAsyncJobContext * >( pvContext );
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ExecuteAsync(CAsyncJobContext *pAsync) {
    Assert(!m_pAsyncJob);
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::CommandRequiresSignIn(const char *command) {
    // Blech again!
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::CommandRequiresStorageDevice(const char *command) {
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::CommandRespectsSignInDenied(const char *command) {
...
class CAsyncCtxOnDeviceAttached : public CCBasePanelBasePanel::CAsyncJobContext {
public:
...
CAsyncCtxOnDeviceAttached::CAsyncCtxOnDeviceAttached() :
        CCBasePanelBasePanel::CAsyncJobContext(3.0f),    // Storage device info for at least 3 seconds
...
void CCBasePanelBasePanel::OnDeviceAttached(void) {
    ExecuteAsync(new CAsyncCtxOnDeviceAttached);
}

void CCBasePanelBasePanel::OnCompletedAsyncDeviceAttached(CAsyncCtxOnDeviceAttached *job) {
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::ValidateStorageDevice(void) {
...
bool CCBasePanelBasePanel::ValidateStorageDevice(int *pStorageDeviceValidated) {
    if (m_pStorageDeviceValidatedNotify) {
...
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::HandleSignInRequest(const char *command) {
#ifdef _X360
...
// Input  : *command -
//-----------------------------------------------------------------------------
bool CCBasePanelBasePanel::HandleStorageDeviceRequest(const char *command) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ClearPostPromptCommand(const char *pCompletedCommand) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::IssuePostPromptCommand(void) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnCommand(const char *command) {
    if (GameUI().IsConsoleUI()) {
#if defined( _X360 )
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunAnimationWithCallback(vgui::Panel *parent, const char *animName, KeyValues *msgFunc) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnOpenQuitConfirmationDialog() {
    if (GameUI().IsConsoleUI()) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::OnOpenDisconnectConfirmationDialog() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ApplyOptionsDialogSettings() {
    if (m_hOptionsDialog.Get()) {
...
void CCBasePanelBasePanel::OnOpenCSAchievementsDialog() {
    if (GameClientExports()) {
        int screenWide = 0;
        int screenHeight = 0;
...
void CCBasePanelBasePanel::OnOpenAchievementsDialog_Xbox() {
    if (!m_hAchievementsDialog.Get()) {
...
//-----------------------------------------------------------------------------
CMatchmakingBasePanel *CCBasePanelBasePanel::GetMatchmakingBasePanel() {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::PositionDialog(vgui::PHandle dlg) {
    if (!dlg.Get())
        return;
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::ShowMessageDialog(const uint nType, vgui::Panel *pOwner) {
    if (pOwner == NULL) {
        pOwner = this;
    }
...
// Purpose: Add an Xbox 360 message dialog to a dialog stack
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::CloseMessageDialog(const uint nType) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::SessionNotification(const int notification, const int param) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::SystemNotification(const int notification) {
    CMatchmakingBasePanel *pBase = GetMatchmakingBasePanel();
    if (pBase) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::UpdatePlayerInfo(uint64 nPlayerId, const char *pName, int nTeam, byte cVoiceState, int nPlayersNeeded,
                                  bool bHost) {
    CMatchmakingBasePanel *pBase = GetMatchmakingBasePanel();
    if (pBase) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::SessionSearchResult(int searchIdx, void *pHostData, XSESSION_SEARCHRESULT *pResult, int ping) {
    CMatchmakingBasePanel *pBase = GetMatchmakingBasePanel();
    if (pBase) {
...
void CCBasePanelBasePanel::OnCreditsFinished(void) {
    if (!IsX360()) {
        // valid for 360 only
        Assert(0);
        return;
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::SetMenuAlpha(int alpha) {
    if (GameUI().IsConsoleUI()) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::FadeToBlackAndRunEngineCommand(const char *engineCommand) {
...
void CCBasePanelBasePanel::SetMenuItemBlinkingState(const char *itemName, bool state) {
    for (int i = 0; i < GetChildCount(); i++) {
        Panel * child = GetChild(i);
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunEngineCommand(const char *command) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::RunCloseAnimation(const char *animName) {
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::FinishDialogClose(void) {
}
...
//-----------------------------------------------------------------------------
void CCBasePanelBasePanel::Reload_Resources( const CCommand &args )
{
...
void
CMessageDialogHandler::CreateMessageDialog(const uint nType, const char *pTitle, const char *pMsg, const char *pCmdA,
    ...
    // Show the new dialog
    m_hMessageDialogs[nStackIdx] = new CMessageDialog(BasePanel(), nType, pTitle, pMsg, pCmdA, pCmdB, pCreator,
                                                      bShowActivity);
...
//-----------------------------------------------------------------------------
// Purpose: Editable panel that can replace the GameMenuButtons in CCBasePanelBasePanel
//-----------------------------------------------------------------------------
...
static void RefreshOptionsDialog(const CCommand &args) {
    if (g_hOptionsDialog) {
        CCBasePanelBasePanel *pBasePanel = (CCBasePanelBasePanel *) g_hOptionsDialog->GetParent();
