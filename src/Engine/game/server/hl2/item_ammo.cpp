...
LINK_ENTITY_TO_CLASS(item_box_ak47rounds, CItem_BoxAK47Rounds);
LINK_ENTITY_TO_CLASS(item_ammo_ak47, CItem_BoxAK47Rounds);

// ========================================================================
//	>> Large Box 9mm AK47 Rounds
// ========================================================================
class CItem_LargeBoxAK47Rounds : public CItem {
public:
    DECLARE_CLASS(CItem_LargeBoxAK47Rounds, CItem);
    ...
    bool MyTouch(CBasePlayer *pPlayer) {
        if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_AK47_LARGE, "AK47")) {
            if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO) {
                UTIL_Remove(this);
            }
            return true;
...
LINK_ENTITY_TO_CLASS(item_large_box_ak47rounds, CItem_LargeBoxAK47Rounds);
LINK_ENTITY_TO_CLASS(item_ammo_ak47_large, CItem_LargeBoxAK47Rounds);
