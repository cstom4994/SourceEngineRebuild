...
void CNPC_AlienGrunt::HandleAnimEvent(animevent_t *pEvent) {
    switch (pEvent->event) {
        ...
        case AGRUNT_AE_HORNET5: {
            ...
            CHL1BaseNPC * pHornetMonster = (CHL1BaseNPC * )
            pHornet->MyNPCPointer();
        ...
        case AGRUNT_AE_LEFT_PUNCH: {
            ...
            CBaseEntity *pHurt = CheckTraceHullAttack(AGRUNT_MELEE_DIST, vecMins, vecMaxs,
