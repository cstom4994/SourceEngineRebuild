...
void CNPC_Zombie::HandleAnimEvent(animevent_t *pEvent) {
    ...
    switch (pEvent->event) {
        case ZOMBIE_AE_ATTACK_RIGHT: {
            ...
            CBaseEntity *pHurt = CheckTraceHullAttack(70, vecMins, vecMaxs, sk_zombie_dmg_one_slash.GetFloat(),
                                                      DMG_SLASH);
        ...
        case ZOMBIE_AE_ATTACK_BOTH: {
            ...
            CBaseEntity *pHurt = CheckTraceHullAttack(70, vecMins, vecMaxs, sk_zombie_dmg_both_slash.GetFloat(),
                                                      DMG_SLASH);
