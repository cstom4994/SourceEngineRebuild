...
#elif defined(PONDER_CLIENT_DLL)
...
#if defined( _DEBUG ) || defined( PONDER_CLIENT_DLL )
	bool bItemDebugValidation = false;
#endif // defined( _DEBUG ) || defined( PONDER_CLIENT_DLL )
...
#endif // defined( TF_DLL ) || defined( PONDER_CLIENT_DLL )
