...
BEGIN_RECV_TABLE(CHalfLife2Proxy, DT_HalfLife2Proxy)
                    RecvPropDataTable("hl2_gamerules_data", 0, 0, &REFERENCE_RECV_TABLE(DT_HL2GameRules),
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
        ...
        def.AddAmmoType("Ak47", DMG_BULLET, TRACER_LINE_AND_WHIZ, "sk_plr_dmg_ak47", "sk_npc_dmg_ak47", "sk_max_ak47",
                        BULLET_IMPULSE(150, 1225), 0);
