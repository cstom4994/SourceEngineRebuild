...
//=============================================================================
        ...
        , m_CallbackUserStatsReceived(this, &CAchievementMgr::Steam_OnUserStatsReceived),
                                                                              m_CallbackUserStatsStored(this,
...
void CAchievementMgr::AwardAchievement(int iAchievementID) {
    ...
    if (IsPC()) {
#ifndef NO_STEAM
        if (steamapicontext->SteamUserStats()) { VPROF_BUDGET("AwardAchievement", VPROF_BUDGETGROUP_STEAM);
...
//-----------------------------------------------------------------------------
void
CAchievementMgr::OnKillEvent(CBaseEntity *pVictim, CBaseEntity *pAttacker, CBaseEntity *pInflictor, IGameEvent *event) {
