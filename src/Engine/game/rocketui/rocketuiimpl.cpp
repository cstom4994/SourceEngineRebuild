...
bool RocketUIImpl::LoadFont(const char *filepath, const char *path) {
    ...
    if (!Rml::LoadFontFace(fontBuffer, fontLen, "Lato", Rml::Style::FontStyle::Normal, Rml::Style::FontWeight::Normal,
                           false)) {
...
Rml::ElementDocument *RocketUIImpl::LoadDocumentFile(RocketDesinationContext_t ctx, const char *filepath,
                                                     LoadDocumentFn loadDocumentFunc,
                                                     UnloadDocumentFn unloadDocumentFunc) {
    ...
    if (loadDocumentFunc && unloadDocumentFunc) {
        ...
        CUtlPair<RocketDesinationContext_t, CUtlPair<LoadDocumentFn, UnloadDocumentFn>> reloadFunctionEntry(ctx,
                                                                                                            documentFuncPair);
