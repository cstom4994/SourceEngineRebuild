...
RocketRender::CompileGeometry(Rml::Vertex *vertices, int num_vertices, int *indices, int num_indices,
...
bool RocketRender::LoadTexture(Rml::TextureHandle &texture_handle, Rml::Vector2i &texture_dimensions,
    ...
    for (long y = 0; y < header.height; y++) {
        ...
        long write_index = ((header.imageDescriptor & 32) != 0) ? read_index : (header.height - y - 1) * header.width *
                                                                               color_mode;
...
bool RocketRender::GenerateTexture(Rml::TextureHandle &texture_handle, const Rml::byte *source,
