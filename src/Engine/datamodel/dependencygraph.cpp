...
unsigned int HashEntryKeyFunc(CAttributeNode *const &keyinfo) {
...
//-----------------------------------------------------------------------------
bool
CDependencyGraph::GetOperatorOrdering(CUtlVector<COperatorNode *> &pOpNodes, CUtlVector<IDmeOperator *> &operators) {
    bool cycle = false;
