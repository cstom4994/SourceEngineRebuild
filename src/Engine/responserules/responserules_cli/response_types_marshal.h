...
namespace ResponseRulesCLI {
    ...
    public
    value class SingletonResponseSystem_t {
    public:
        property ResponseSystemCLI
        ^RS
        {
    ...
    public:
        ...
        */
        ...
        property responseparams_interval_t
        delay
        {
        ...
        property bool IsSpeakOnce
                {
                        bool get() {
                    return (((ParamFlags_t) (flags)) & ParamFlags_t::RG_RESPEAKDELAY) != ParamFlags_t::None;
                }
                }
        property byte
        soundlevel
    ...
    public ref class ResponseGroup : public NativeTypeCopyWrapper<ResponseRules::ResponseGroup> {
        typedef
    public
        NativeTypeCopyWrapper<ResponseRules::ResponseGroup> BaseClass;
    public:
        ResponseGroup() {};
        ...
        property System::Collections::IList
        ^ ResponsesList
        {
    ...
    public:
        ...
        Rule(ResponseRules::Rule *x, ResponseRules::ResponseRulePartition::tIndex idx, const char *name) :
                BaseClass(x, false), m_index(idx), m_name(gcnew

        String(name)
        ),
        m_ResponseGroupsAsList( nullptr ), m_CriteriaAsList( nullptr )
        {
            m_ResponseGroupsAsList = gcnew
            ResGroupAsIList_t(
                    gcnew
            ResGroupAsIList_t::lGetter(this, &ResponseGroups::get),
                    gcnew
            ResGroupAsIList_t::lCounter(this, &NumResponses::get));

            m_CriteriaAsList = gcnew
            CriteriaAsIList_t(
                    gcnew
            CriteriaAsIList_t::lGetter(this, &Criteria::get),
                    gcnew
            CriteriaAsIList_t::lCounter(this, &NumCriteria::get));
        };
        ...
        property ResGroupAsIList_t
        ^ResponseGroupsAsIList
        {
        ...
        property CriteriaAsIList_t
        ^CriteriaAsIList
        {
            CriteriaAsIList_t ^get() { return m_CriteriaAsList; }
        }

        property ResponseRules::ResponseRulePartition::tIndex
        IndexInResponseSystem
        {
