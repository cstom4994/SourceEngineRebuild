...
namespace ResponseRulesCLI {
    ...
    public:
        ...
        property ResponseGroupDictWrapper_t
        ^ResponseGroupsDict
        {
            ResponseGroupDictWrapper_t ^get() { return m_ResponseGroupsDict; }
        }

        property CriterionDictWrapper_t
        ^CriteriaDict
        {
        ...
        */
        ...
        ref class RulesAsList
                : public System::Collections::IEnumerable, System::Collections::Specialized::INotifyCollectionChanged {
        public:

            ref struct RulesIterator : System::Collections::IEnumerator {
            public:
                RulesIterator(ResponseSystemCLI^enumerable) :
                        m_System(enumerable), m_bIsBefore(false),
                        m_idx(ResponseRules::ResponseRulePartition::InvalidIdx()) { Reset(); };
...
#pragma region INotifyCollectionChanged interface
            ...
            virtual event System::Collections::Specialized::NotifyCollectionChangedEventHandler
            ^CollectionChanged
            {
...
#pragma region "Queries Into Response System"
        ...
        ^ FindAllRulesMatchingCriteria(System::Collections::IDictionary ^facts);
