...
public:
    ...
    lGetter(int idx); // will wrap the indexer
...
#pragma region Enumerator
    ...
    public:
        ...
        virtual property System::Object
        ^ CurrentAgainBecauseCPP_CLISucks
        {
...
public:
    ...
    // copy constructor
    NativeTypeCopyWrapper(NativeTypeCopyWrapper
...
#pragma region Enumeration interface
    ...
    */
    ...
    CONVERTOR ^GetValue(I idx) {
        return gcnew
        CONVERTOR(m_pInnerDict->Element(idx));
    }

    CONVERTOR ^GetKey(I idx) {
        return gcnew
        String(m_pInnerDict->GetElementName(idx));
    }
    ...
    ref struct Enumerator : public System::Collections::IEnumerator {
        ...
        ^ Current
        {
            virtual System::Object ^ get() {
                if (IsValid()) {
                    return gcnew
                    tuple_t(m_pEnumeratedDict->GetElementName(m_index),
...
#pragma endregion
    ...
    tuple_t ^GetElement(I i) {
        return gcnew
        tuple_t(m_pInnerDict->GetElementName(i),
