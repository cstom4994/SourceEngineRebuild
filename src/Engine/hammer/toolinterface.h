...
public:
    ...
    virtual ChunkFileResult_t
    SaveVMF(CChunkFile *pFile, CSaveInfo *pSaveInfo) { return (ChunkFileResult_t) 0; /*ChunkFile_Ok*/ }
    ...
    virtual bool
    OnMouseWheelLogical(CMapViewLogical *pView, UINT nFlags, short zDelta, const Vector2D &vPoint) { return false; }
