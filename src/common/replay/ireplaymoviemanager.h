...
public:
    ...
    virtual IReplayMovie *
    CreateAndAddMovie(ReplayHandle_t hReplay) = 0;    // Creates and adds a movie based on the given replay
    ...
    virtual void
    GetCachedMovieTitleAndClear(wchar_t *pOut, int nOutBufLength) = 0;    // TODO: This is a hack - fix this
