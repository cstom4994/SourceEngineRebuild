...
struct hfxVec3
...
#ifndef HFX_INTERNAL
    HFX_INLINE HFX_EXPLICIT

    hfxVec3(const double &_x, const double &_y, const double &_z);

    HFX_INLINE HFX_EXPLICIT

    hfxVec3(const double array_d[3]);
    ...
    operator-(const hfxVec3 &vect) const;

    HFX_INLINE hfxVec3
    &

    operator-=(const hfxVec3 &vect);
    ...
    operator*(const double &df) const;
    ...
    Cross(const hfxVec3 &vect) const;
...
struct hfxVec3F : public HFX_vect3Base32 {
    ...
    operator-(const hfxVec3F &vect) const;

    HFX_INLINE hfxVec3F
    &

    operator-=(const hfxVec3F &vect);
    ...
    Cross(const hfxVec3F &vect) const;
