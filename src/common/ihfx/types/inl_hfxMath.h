...
HFXVEC3_DEFTYPE::Normalized() const {
    hfxVec3 copy(m);
...
HFXVEC3_DEFTYPE::Normal() const { return Normalized(); };
#endif
...
HFXVEC3_DEFTYPE::Cross(const hfxVec3 &v) const {
...
HFXVEC3_DEFTYPE::operator-() const { return (hfxVec3(-x, -y, -z)); }
...
HFXVEC3_DEFTYPE::operator*(const hfxVec3 &v) const { HFXVEC3(v, *); }
...
HFXVEC3_DEFTYPE::operator=(const hfxVec3 &v) { HFXVEC3SELF(v, =); }
...
HFXVEC3_DEFTYPE::operator*(const double &d) const { HFXVEC3F(d, *); }
...
HFXVEC3_DEFTYPE::operator*=(const double &d) { HFXVEC3FSELF(d, *=); }
...
HFXVEC3_DEFTYPE::operator=(const double &d) {
    x = y = z = d;
    return (*this);
}
...
hfxVec3F::Normal() const { return Normalized(); };
#endif
...
hfxVec3F::Cross(const hfxVec3F &v) const { return hfxVec3F(x * v.z - z * v.y, z * v.x - x * v.z, x * v.y - y * v.x); }
...
hfxVec3F::operator-() const { return (hfxVec3F(-x, -y, -z)); }
...
hfxVec3F::operator*(const hfxVec3F &v) const { HFXVEC3(v, *); }
...
hfxVec3F::operator=(const hfxVec3F &v) { HFXVEC3SELF(v, =); }
...
hfxVec3F::operator*(const float f) const { HFXVEC3F(f, *); }
...
hfxVec3F::operator*=(const float f) { HFXVEC3FSELF(f, *=); }
...
hfxVec3F::operator=(const float f) {
    x = y = z = f;
    return (*this);
}
