...
#define HFX_PARAMETER_INT_ARRAY(size, name, membername) \
    ...
    virtual bool SetVar(const HFXParamID id, void *value, HFXParamType t,
                        HFXARRAY settype = HFXARRAY_NOTARRAY, unsigned int indexORcount = 0,
    ...
    HFX_INLINE bool SetVar(const HFXParamID name, HFXVarValue value, HFXParamType t,
                           bool allowMake) { return SetVar(name, value, t, HFXARRAY_NOTARRAY, 0, allowMake); }
    ...
    HFX_INLINE bool SetVarArray(const HFXParamID name, unsigned int arraySize, const int *value,
                                bool allowMake = false) {
    ...
    HFX_INLINE bool SetVarDoubleArray(const HFXParamID name, unsigned int size, const double *value,
                                      bool allowMake = false) { return SetVarArray(name, size, value, allowMake); }
    ...
    HFX_INLINE bool SetVarIntArrayByName(const char *name, unsigned int size, const int *value,
                                         bool allowMake = false) {
        return SetVarArrayByName(name, size, value, allowMake);
    }

    HFX_INLINE bool SetVarIntArray(const HFXParamID name, unsigned int size, const int *value,
                                   bool allowMake = false) { return SetVarArray(name, size, value, allowMake); }
    ...
    HFX_INLINE bool SetVarBoolArray(const HFXParamID name, unsigned int size, const bool *value,
                                    bool allowMake = false) { return SetVarArray(name, size, value, allowMake); }
    ...
    HFX_INLINE bool GetVarFloatByName(const char *name, float &value) const { return GetVarByName(name, value); }

    HFX_INLINE bool GetVarDoubleByName(const char *name, double &value) const { return GetVarByName(name, value); }

    HFX_INLINE bool GetVarIntByName(const char *name, int &value) const { return GetVarByName(name, value); }

    HFX_INLINE bool GetVarBoolByName(const char *name, bool &value) const { return GetVarByName(name, value); }
    ...
    HFX_INLINE bool GetVarFloat(const HFXParamID name, float &value) const { return GetVar(name, value); }

    HFX_INLINE bool GetVarDouble(const HFXParamID name, double &value) const { return GetVar(name, value); }

    HFX_INLINE bool GetVarInt(const HFXParamID name, int &value) const { return GetVar(name, value); }

    HFX_INLINE bool GetVarBool(const HFXParamID name, bool &value) const { return GetVar(name, value); }
...
*/
    ...
    // creation
    virtual bool
    CreateStandardEffect(IHFXEffect *&pHandle, class IStack *createOnStack = 0, const char *customName = 0) = 0;
