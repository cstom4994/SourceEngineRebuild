    ...
    for (int nConfig = 0; nConfig < nNumConfigs; nConfig++) {
        ...
        if (nCount > 0) {
            ...
            do {
                ...
                nStrlen = GetPrivateProfileString(szSectionName, szGameData, "", textBuffer, sizeof(textBuffer),
                                                  iniFilePath);
            ...
            hammerBlock->SetInt("MapFormat", GetPrivateProfileInt(szSectionName, "MapFormat", 4 /*FIXME: mfHalfLife2*/,
                                                                  iniFilePath));
            ...
            hammerBlock->SetInt("DefaultLightmapScale", GetPrivateProfileInt(szSectionName, "DefaultLightmapScale",
