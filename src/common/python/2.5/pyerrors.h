...
PyAPI_FUNC(void)
PyErr_SetObject(PyObject * , PyObject * ) ;
PyAPI_FUNC(void)
...
PyErr_Clear(void);
PyAPI_FUNC(void)
PyErr_Fetch(PyObject * * , PyObject ** , PyObject ** ) ;
PyAPI_FUNC(void)
PyErr_Restore(PyObject * , PyObject * , PyObject * ) ;
...
PyAPI_FUNC(int)
PyErr_GivenExceptionMatches(PyObject * , PyObject * ) ;
PyAPI_FUNC(int)
...
PyAPI_FUNC(int)
PyErr_WarnEx(PyObject * category , const char *msg,
        Py_ssize_t
stack_level ) ;
PyAPI_FUNC(int)
PyErr_WarnExplicit(PyObject * , const char * ,
const char * , int ,
const char * , PyObject * ) ;
...
PyAPI_FUNC(void)
PyErr_SyntaxLocation(const char *, int);
