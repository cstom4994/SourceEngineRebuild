...
PyAPI_FUNC(int)
PyObject_Cmp(PyObject * o1 , PyObject *o2,
int *result ) ;
...
PyAPI_FUNC(Py_ssize_t)
PyNumber_AsSsize_t(PyObject * o , PyObject *exc ) ;
...
PyAPI_FUNC(PyObject * ) PySequence_GetSlice(PyObject * o , Py_ssize_t i1, Py_ssize_t
i2 ) ;
...
PyAPI_FUNC(int)
PySequence_SetItem(PyObject * o , Py_ssize_t i, PyObject * v ) ;
...
PyAPI_FUNC(int)
PySequence_DelItem(PyObject * o , Py_ssize_t i ) ;
...
PyAPI_FUNC(int)
PySequence_SetSlice(PyObject * o , Py_ssize_t i1, Py_ssize_t
i2 ,
PyObject *v ) ;
...
PyAPI_FUNC(int)
PySequence_DelSlice(PyObject * o , Py_ssize_t i1, Py_ssize_t
i2 ) ;
...
PyAPI_FUNC(int)
PyObject_IsInstance(PyObject * object , PyObject *typeorclass ) ;
/* isinstance(object, typeorclass) */

PyAPI_FUNC(int)
PyObject_IsSubclass(PyObject * object , PyObject *typeorclass ) ;
