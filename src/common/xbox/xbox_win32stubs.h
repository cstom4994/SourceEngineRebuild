...
FORCEINLINE DWORD
XBX_GetEnvironmentVariable( LPCTSTR
lpName,
...
PLATFORM_INTERFACE DWORD
XBX_GetCurrentDirectory( DWORD
nBufferLength,
LPTSTR lpBuffer
);
...
PLATFORM_INTERFACE DWORD
XBX_GetModuleFileName( HMODULE
hModule,
LPTSTR lpFilename, DWORD
nSize );
...
FORCEINLINE COORD
GetLargestConsoleWindowSize( HANDLE ) {COORD c = { 0, 0 }; return c;}
...
FORCEINLINE BOOL
ReadConsoleOutputCharacter( HANDLE, LPTSTR, DWORD, COORD, LPDWORD
) {
return false; }

FORCEINLINE BOOL
WriteConsoleInput( HANDLE, CONST
INPUT_RECORD*, DWORD, LPDWORD ) {
return false; }

FORCEINLINE HWND
GetDesktopWindow(VOID) {return (HWND)0;}
...
DosDateTimeToFileTime(const WORD wFatDate, const WORD wFatTime, LPFILETIME lpFileTime) {
...
CreateFontA(int, int, int, int, int, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPCSTR) { return 0; }
...
FORCEINLINE HBRUSH
CreateSolidBrush( COLORREF ) {return 0;}
...
FORCEINLINE HANDLE
LoadImage( HINSTANCE, LPCSTR, UINT,
int, int, UINT) {
return 0; }
FORCEINLINE HANDLE
LoadImageA( HINSTANCE, LPCSTR, UINT,
int, int, UINT) {
return 0; }
...
FORCEINLINE BOOL
BitBlt( HDC,
int, int, int, int, HDC, int, int, DWORD ) {
return false; }

FORCEINLINE HGDIOBJ

GetStockObject(int) { return 0; }
...
GetDC(HWND
hWnd) {
return (HDC)0x12345678; }

FORCEINLINE void ReleaseDC(HWND
hWnd,
HDC hDC
) {
}
...
FORCEINLINE HDC
CreateCompatibleDC( HDC ) {return 0;}
...
joyGetNumDevs(void) { return 0; }

FORCEINLINE HKL
GetKeyboardLayout( DWORD ) {return NULL;}

FORCEINLINE HKL
LoadKeyboardLayout( LPCTSTR, UINT
) {
return
NULL;
}
...
FORCEINLINE UINT
MapVirtualKeyEx( UINT, UINT, HKL
) {
return 0; }

FORCEINLINE SHORT

GetKeyState(int nVirtKey) { return 0; }
...
RegOpenKeyEx( HKEY
hKey,
LPCTSTR lpSubKey, DWORD
ulOptions,
REGSAM samDesired, PHKEY
phkResult ) {
return -1; }
...
hKey,
LPCTSTR lpValueName, LPDWORD
lpReserved,
LPDWORD lpType, LPBYTE
lpData,
LPDWORD lpcbData
) {
return -1; }
...
SetCursorPos(int x, int y) { return FALSE; }
...
FORCEINLINE MCIERROR
mciGetDeviceID( LPCTSTR ) {return 0;}

FORCEINLINE MCIERROR
mciSendString( LPCTSTR
lpszCommand,
LPTSTR lpszReturnString, UINT
cchReturn,
HANDLE hwndCallback
) {
return 0; }
...
FORCEINLINE MCIERROR
mciSendCommand( MCIDEVICEID, UINT, DWORD, DWORD
) {
return (UINT)MCIERR_DRIVER; }

FORCEINLINE BOOL
mciGetErrorString( MCIERROR, LPTSTR, UINT
) {
return false; };
...
FORCEINLINE HANDLE
CreateFileMapping( HANDLE, LPSECURITY_ATTRIBUTES, DWORD, DWORD, DWORD, LPCTSTR
) {
return
NULL;
}
...
FORCEINLINE LPVOID
MapViewOfFile( HANDLE, DWORD, DWORD, DWORD, SIZE_T
) {
return
NULL;
}
...
FORCEINLINE BOOL
UnmapViewOfFile( LPCVOID ) {return false;}
...
FORCEINLINE BOOL
HttpQueryInfo( HINTERNET
hRequest,
DWORD dwInfoLevel, LPVOID
lpBuffer,
LPDWORD lpdwBufferLength, LPDWORD
lpdwIndex ) {
return false; }

FORCEINLINE struct hostent FAR
*
_stdcall FAR

gethostbyname(const char FAR
...
FORCEINLINE BOOL
InternetReadFile(HINTERNET
hFile,
LPVOID lpBuffer, DWORD
...
FORCEINLINE BOOL
InternetCrackUrl( LPCSTR
lpszUrl,
DWORD dwUrlLength, DWORD
dwFlags,
LPURL_COMPONENTS lpUrlComponents
) {
return false; }

FORCEINLINE HINTERNET
InternetOpen( LPCSTR
lpszAgent,
DWORD dwAccessType, LPCSTR
lpszProxy OPTIONAL, LPCSTR
lpszProxyBypass OPTIONAL, DWORD
dwFlags ) {
return 0; }

FORCEINLINE INTERNET_STATUS_CALLBACK
InternetSetStatusCallback( HINTERNET
hInternet,
...
hInternet,
LPCSTR lpszUrl, LPCSTR
lpszHeaders OPTIONAL, DWORD
dwHeadersLength,
...
FORCEINLINE DWORD
MsgWaitForMultipleObjects( DWORD, CONST
...
FORCEINLINE BOOL
GetProcessTimes( HANDLE, LPFILETIME
ft1,
LPFILETIME ft2, LPFILETIME
ft3,
LPFILETIME ft4
) {
return false; }
...
FORCEINLINE long Time(long *today) {
    ...
    if (today) *today = ul.QuadPart;
    return ul.QuadPart;
}

FORCEINLINE BOOL
CreateProcess( LPCSTR
lpApplicationName,
LPSTR lpCommandLine,
...
PLATFORM_INTERFACE DWORD
g_dwProcessAffinityMask;

FORCEINLINE bool GetProcessAffinityMask(HANDLE
hProcess,
DWORD *lpProcessAffinityMask, DWORD
...
FORCEINLINE bool SetProcessAffinityMask(HANDLE
hProcess,
...
FORCEINLINE IAudioDevice
*

Audio_CreateWaveDevice(void) { return NULL; }

FORCEINLINE IAudioDevice
*

Audio_CreateDirectSoundDevice(void) { return NULL; }

FORCEINLINE CAudioSource
*

Voice_SetupAudioSource(int soundsource, int entchannel) { return NULL; }
...
enum EServerMode;
FORCEINLINE ISteamClient
*

SteamClient() { return NULL; }

FORCEINLINE ISteamGameServer
*

SteamGameServer() { return NULL; }

FORCEINLINE ISteamUtils
*

SteamGameServerUtils() { return NULL; }

FORCEINLINE ISteamUtils
*

SteamUtils() { return NULL; }

FORCEINLINE ISteamUser
*

SteamUser() { return NULL; }

FORCEINLINE ISteamUserStats
*

SteamUserStats() { return NULL; }

FORCEINLINE ISteamFriends
*

SteamFriends() { return NULL; }

FORCEINLINE int32

GetHSteamPipe() { return 0; }

FORCEINLINE int32

GetHSteamUser() { return 0; }

FORCEINLINE int32

SteamAPI_GetHSteamPipe() { return 0; }

FORCEINLINE int32

SteamAPI_GetHSteamUser() { return 0; }

FORCEINLINE ISteamMasterServerUpdater
*

SteamMasterServerUpdater() { return NULL; }

FORCEINLINE bool
SteamGameServer_Init(uint32 unIP, uint16 usPort, uint16 usGamePort, uint16 usSpectatorPort, uint16 usQueryPort,
                     EServerMode eServerMode, int nGameAppId, const char *pchGameDir,
                     const char *pchVersionString) { return false; }
...
hWnd,
int nIndex
);  // false stub -- no work has been done to make unicode version of this function on 360
PLATFORM_INTERFACE LONG_PTR
SetWindowLongPtrW( HWND
hWnd,
int nIndex, LONG
dwNewLong ); // false stub -- no work has been done to make unicode version of this function on 360
PLATFORM_INTERFACE HWND
CreateWindow( LPCTSTR
lpClassName,
LPCTSTR lpWindowName, DWORD
dwStyle,
int x,
int y,
int nWidth,
...
PLATFORM_INTERFACE int GetDeviceCaps(HDC
hdc,
int nIndex
);
PLATFORM_INTERFACE LRESULT
