...
bool CopyWithReplacements(
    ...
    int dataWriteLen;
    CUtlVector<char> *pCurData = GetFileStringWithReplacements(pInputFilename, ppReplacements, nReplacements,
                                                               dataWriteLen);
    if (!pCurData) {
        char msg[512];
...
void VGUIMessageBox(vgui::Panel * pParent,
const char *pTitle,
const char *pMsg, ...
)
{
