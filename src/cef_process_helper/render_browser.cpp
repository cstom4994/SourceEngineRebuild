...
// Purpose: 
//-----------------------------------------------------------------------------
RenderBrowser::RenderBrowser(CefRefPtr<CefBrowser> browser, CefRefPtr<ClientApp> clientApp) : m_Browser(browser),
...
bool RenderBrowser::CreateFunction(CefString identifier, CefString name, CefString parentIdentifier, bool bCallback) {
    ...
    CefRefPtr<FunctionV8Handler> funcHandler = !bCallback ? new FunctionV8Handler(this)
                                                          : new FunctionWithCallbackV8Handler(this);
...
// Purpose: 
//-----------------------------------------------------------------------------
bool RenderBrowser::InvokeWithResult(CefString resultIdentifier, CefString identifier, CefString methodname,
