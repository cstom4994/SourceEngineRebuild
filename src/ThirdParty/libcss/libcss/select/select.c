...
#include <thirdparty/libcss/libcss/select.h>

#include "thirdparty/libcss/libcss/bytecode/bytecode.h"
#include "thirdparty/libcss/libcss/bytecode/opcodes.h"
#include "thirdparty/libcss/libcss/stylesheet.h"
#include "thirdparty/libcss/libcss/select/arena.h"
#include "thirdparty/libcss/libcss/select/computed.h"
#include "thirdparty/libcss/libcss/select/dispatch.h"
#include "thirdparty/libcss/libcss/select/hash.h"
#include "thirdparty/libcss/libcss/select/mq.h"
#include "thirdparty/libcss/libcss/select/propset.h"
#include "thirdparty/libcss/libcss/select/font_face.h"
    ...
    const css_stylesheet* sheet, css_select_state* state)
{
    ...
    css_selector*** class_selectors = NULL;
    ...
    while (_selectors_pending(node_selectors, id_selectors,
        ...
        case CSS_SELECT_RULE_SRC_CLASS:
            req.classname = state->classes[src.class];
