...
int Menu::GetVisibleItemIndex(int sortedIndex) {
    ...
    while (m_SortedItems.IsValidIndex(findVisible) && findVisible < sortedIndex) {
        if (m_MenuItems.IsValidIndex(m_SortedItems[findVisible]) &&
            m_MenuItems[m_SortedItems[findVisible]]->IsVisible())
            numVisible++;
...
int Menu::GetNextVisible(int sortedIndex) {
    ...
    while (m_SortedItems.IsValidIndex(sortedIndex)) {
        if (m_MenuItems.IsValidIndex(m_SortedItems[sortedIndex]) &&
            m_MenuItems[m_SortedItems[sortedIndex]]->IsVisible())
            return sortedIndex;
