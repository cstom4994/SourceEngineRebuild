...
CDialog_EditorConfig::CDialog_EditorConfig(Panel *parent) : Frame(parent, "_editor_config") {
    ...
    m_pCBut_Compile_Publish = new CheckButton(this, "compile_auto_publish",
                                              "Auto publish shaders to materials (full compile)");
    m_pCBut_Compile_WarnOnSave = new CheckButton(this, "warn_on_close_tab",
                                                 "Warn when closing a tab with unsaved changes");
