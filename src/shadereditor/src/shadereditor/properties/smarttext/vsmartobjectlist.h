...
public:
    ...
    void ParseCode_Stream(CUtlBuffer &hStream, bool bRecursive = false, CUtlVector<char *> *hIncludes = NULL,
                          const char *sourceFile = NULL, int scopeOffset = -1);
...
private:
    ...
    void ParseCode_PreProc(CUtlVector<char *> &hLines, bool bRecursive, CUtlVector<char *> *hIncludes,
