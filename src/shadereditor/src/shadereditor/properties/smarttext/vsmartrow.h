...
public:
    ...
    inline bool operator>=(const text_cursor &o) const { return *this > o || *this == o; };
    ...
    inline bool operator==(const text_cursor &o) const { return (*this).x == o.x && (*this).y == o.y; };

    inline bool operator!=(const text_cursor &o) const { return !((*this) == o); };
};
