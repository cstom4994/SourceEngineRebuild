...
void CNodeParallax::UpdateNode() {
    ...
    LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT2, "UV");
    iCurJack++;
    LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT3, "View TSpace");
    iCurJack++;
    LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT1, "Parallax Amt");
    iCurJack++;
    //if ( bDepthTest )
    {
        LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT3, "World pos");
        iCurJack++;
    }
    LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT3, "World normal");
    iCurJack++;
    LockJackInput_Flags(iCurJack, HLSLVAR_FLOAT3, "Eye dir");
    iCurJack++;
    LockJackInput_Flags(iCurJack, HLSLVAR_SAMPLER, "Heightmap");
    iCurJack++;
