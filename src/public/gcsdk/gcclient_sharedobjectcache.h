...
//----------------------------------------------------------------------------
    ...
    public:
        ...
        bool BParseCacheSubscribedMsg(const CMsgSOCacheSubscribed_SubscribedType &msg,
...
//----------------------------------------------------------------------------
    ...
    public:
        ...
        FindTypeCache(int nClassID) { return (CGCClientSharedObjectTypeCache *) FindBaseTypeCache(nClassID); }

        CGCClientSharedObjectTypeCache *
        CreateTypeCache(int nClassID) { return (CGCClientSharedObjectTypeCache *) CreateBaseTypeCache(nClassID); }
