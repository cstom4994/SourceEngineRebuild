...
//-----------------------------------------------------------------------------
    ...
    public:
        CGCClientJob(CGCClient *pGCClient) : CJob(pGCClient->GetJobMgr()), m_pGCClient(pGCClient),
    ...
    protected:
        ...
        BYldSendMessageAndGetReplyEx(CProtoBufMsgBase &msgOut, uint nTimeoutSec, CProtoBufMsgBase *pMsgIn,
                                     MsgType_t eMsg) {
            IMsgNetPacket *pNetPacket = NULL;
        ...
        bool BYldSendMessageAndGetReply(CProtoBufMsgBase &msgOut, uint nTimeoutSec, CProtoBufMsgBase *pMsgIn,
                                        MsgType_t eMsg) {
