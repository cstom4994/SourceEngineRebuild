...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        void TallyMultiplexedMessage(MsgType_t eMsg, uint32 uSent, uint32 cRecipients, uint32 uMsgSize,
        ...
        // print out our stats
        void
        PrintStats(bool bShowAll, bool bSortByFrequency, MsgInfo_t::EStatsGroup eGroup, MsgInfo_t::EStatsType eType,
    ...
    private:
        void
        TallyMessageInternal(MsgInfo_t &msgInfo, MsgInfo_t::EStatsType eBucket, uint32 unMsgSize, uint32 nSourceMask,
                             uint32 cMessages = 1);
