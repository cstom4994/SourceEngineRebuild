...
//----------------------------------------------------------------------------
    ...
    enum ESOTypeFlags {
        ...
        k_ESOFlag_SendToOtherGameservers =
        1 << 2,  // will go to subscribed gameservers who are not the owner of the cache
...
//----------------------------------------------------------------------------
    ...
    public:
        ...
        void BuildCacheSubscribedMsg(CMsgSOCacheSubscribed_SubscribedType *pMsgType, uint32 unFlags,
...
//----------------------------------------------------------------------------
    ...
    public:
        ...
        const CUtlVector <CSharedObjectContext::Subscriber_t> &
        GetSubscribers() const { return m_context.GetSubscribers(); }

        CGCSharedObjectTypeCache *
        FindTypeCache(int nClassID) const { return (CGCSharedObjectTypeCache *) FindBaseTypeCache(nClassID); }

        CGCSharedObjectTypeCache *
        CreateTypeCache(int nClassID) { return (CGCSharedObjectTypeCache *) CreateBaseTypeCache(nClassID); }
        ...
        bool
        BYieldingLoadSchObjects(IGCSQLResultSet *pResultSet, const CColumnSet &csRead, const SOClass_t &schDefaults);

        template<typename SOClass_t>
        bool
        BYieldingLoadSchSingleton(IGCSQLResultSet *pResultSet, const CColumnSet &csRead, const SOClass_t &schDefaults);
        ...
        template<typename SOClass_t, typename SchClass_t>
        bool BYieldingLoadProtoBufSingleton(IGCSQLResultSet *pResultSet, const CColumnSet &csRead,
    ...
    protected:
        ...
        AllocateTypeCache(int nClassID) const OVERRIDE { return new CGCSharedObjectTypeCache(nClassID, m_context); }
...
//----------------------------------------------------------------------------
    template<typename SOClass_t>
    bool CGCSharedObjectCache::BYieldingLoadSchObjects(IGCSQLResultSet *pResultSet, const CColumnSet &csRead,
...
//----------------------------------------------------------------------------
    template<typename SOClass_t>
    bool CGCSharedObjectCache::BYieldingLoadSchSingleton(IGCSQLResultSet *pResultSet, const CColumnSet &csRead,
                                                         const SOClass_t &objDefaults) {
        if (NULL == pResultSet)
            return false;
...
//----------------------------------------------------------------------------
    template<typename SOClass_t, typename SchClass_t>
    bool CGCSharedObjectCache::BYieldingLoadProtoBufSingleton(IGCSQLResultSet *pResultSet, const CColumnSet &csRead,
                                                              const SchClass_t &schDefaults) {
        if (NULL == pResultSet)
            return false;
