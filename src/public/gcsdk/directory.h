...
//-----------------------------------------------------------------------------
    ...
    public:
        CGCDirTypeInstance(const char *pszTypeName, uint32 nType, uint32 nInstance, const KeyValues *pKVConfig,
...
//-----------------------------------------------------------------------------
    class CGCDirProcess {
    public:
        CGCDirProcess(uint32 nDirIndex, const char *pchProcessName, const char *pchProcessType,
