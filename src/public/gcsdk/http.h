...
// Container class for useful parsing methods and other utility code used by client or server http code
    ...
    public:
        ...
        const char *
        GetGETParamString(const char *pchGetParamName, const char *pchDefault, bool bMatchCase = false) const;
        ...
        const char *
        GetPOSTParamString(const char *pchGetParamName, const char *pchDefault, bool bMatchCase = false) const;
        ...
        static void RetrieveURLEncodedData(const char *pchQueryString, int nQueryStrLen,
...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        const char *GetResponseHeaderValue(const char *pchName, const char *pchDefault = NULL) const {
        ...
        virtual void SetResponseHeaderValue(const char *pchName, const char *pchValue) {
