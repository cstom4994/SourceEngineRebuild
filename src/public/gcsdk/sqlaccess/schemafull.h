...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        void AddAlterField(const char *pchTableName, const char *pchFieldNameOld, const char *pchFieldNameNew,
                           PfnAlterField_t pfnAlterField);

        // declare that a trigger is on a table
        void AddTrigger(ESchemaCatalog eCatalog, const char *pchTableName, const char *pchTriggerName,
