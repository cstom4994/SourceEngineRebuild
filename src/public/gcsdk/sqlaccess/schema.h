...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        bool
        BGetVarField(const void *pvRecord, const VarField_t *pVarField, uint8 **ppubField, uint32 *pcubField) const;

        bool BSetVarField(void *pvRecord, VarField_t *pVarField, const void *pvData, uint32 cubData, bool *pbRealloced,
                          bool bFreeOnRealloc);
        ...
        void InitRecordRandom(uint8 *pubRecord, uint32 unPrimaryIndex, bool *pbVarBlockRealloced,
        ...
        void AddFK(const char *pchName, const char *pchColumn, const char *pchParentTable, const char *pchParentColumn,
