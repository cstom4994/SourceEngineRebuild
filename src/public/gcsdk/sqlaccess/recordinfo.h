...
// Information about a column in a record (table or result set)
    ...
    public:
        ...
        void Set(const char *pchName, int nSQLColumn, EGCSQLType eGCSQLType, int cubFixedSize, int nColFlags,
                 int cubMaxSize);
...
// Information about a record (table or result set)
    ...
    public:
        ...
        void AddColumn(const char *pchName, int nSQLColumn, EGCSQLType eGCSQLType, int cubFixedSize, int nColFlags,
                       int cubMaxSize);
