...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        virtual bool BAsyncInit(uint32 unAppID, const char *pchDebugName, int iGCIndex, IGameCoordinatorHost *pHost)
        ...
        virtual void HandleMessageFromClient(uint64 ullSenderID, uint32 unMsgType, void *pubData, uint32 cubData)

        OVERRIDE;

        virtual void HandleMessageFromSystem(uint32 unGCSysMsgType, void *pubData, uint32 cubData)

        OVERRIDE;

        virtual void HandleMessageFromGC(int iGCServerIDSender, uint32 unMsgType, void *pubData, uint32 cubData)
        ...
        typedef CUtlDict<CUtlVector < AssertInfo_t * >* >
        AssertInfoDict_t;
