...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        void ProfileJobs(EJobProfileAction ejobProfileAction,
        ...
        int
        CountYieldingJobs() const { return m_ListJobsYieldingRegPri.Count(); } // counts jobs currently in a yielding state
    ...
    private:
        ...
        bool BRouteWorkItemCompletedInternal(JobID_t jobID, bool bWorkItemCanceled, bool bShouldExist,
        ...
        bool BResumeYieldingJobsFromList(CUtlLinkedList<JobYielding_t, int> &listJobsYielding, uint nCurrentIteration,
