...
struct BigPictureStreamingResult_t {
    enum {
        k_iCallback = k_iSteamStreamLauncherCallbacks + 1
    };
    bool m_bSuccess;
    void *m_hwnd;
};
...
struct StopStreamingRequest_t {
    enum {
        k_iCallback = k_iSteamStreamLauncherCallbacks + 2
    };
};
...
struct BigPictureStreamingDone_t {
    enum {
        k_iCallback = k_iSteamStreamLauncherCallbacks + 3
    };
};
...
struct BigPictureStreamRestarting_t {
    enum {
        k_iCallback = k_iSteamStreamLauncherCallbacks + 4
    };
};
