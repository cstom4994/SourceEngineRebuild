...
public:
    ...
    METHOD_DESC(Downloads leaderboard entries for an arbitrary set of users -
    ...
    virtual SteamAPICall_t DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard,
                                                              ...
                                                              CSteamID *prgUsers, int cUsers) = 0;
    ...
    virtual int
    GetMostAchievedAchievementInfo(char *pchName, uint32 unNameBufLen, float *pflPercent, bool *pbAchieved) = 0;
