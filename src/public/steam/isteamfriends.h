...
public:
    ...
    virtual void GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID,
                                            ...
                                            CSteamID *pOutSteamIDMembers, int nMembersCount) = 0;
    ...
    DownloadClanActivityCounts(ARRAY_COUNT(cClansToRequest) CSteamID *psteamIDClans, int cClansToRequest) = 0;
    ...
    virtual int GetClanChatMessage(CSteamID steamIDClanChat, int iMessage, void *prgchText, int cchTextMax,
                                   EChatEntryType *peChatEntryType, OUT_STRUCT() CSteamID *psteamidChatter) = 0;
