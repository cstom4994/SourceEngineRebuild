...
inline bool
SteamGameServer_Init(uint32 unIP, uint16 usSteamPort, uint16 usGamePort, uint16 usQueryPort, EServerMode eServerMode,
...
inline CSteamGameServerAPIContext &SteamGameServerInternal_ModuleContext() {
    ...
    static void *s_CallbackCounterAndContext[
            2 + sizeof(CSteamGameServerAPIContext) / sizeof(void *)] = {(void *) &SteamGameServerInternal_OnContextInit,
                                                                        0};
...
inline ISteamNetworking *
SteamGameServerNetworking() { return SteamGameServerInternal_ModuleContext().SteamGameServerNetworking(); }

inline ISteamGameServerStats *
SteamGameServerStats() { return SteamGameServerInternal_ModuleContext().SteamGameServerStats(); }
...
inline bool CSteamGameServerAPIContext::Init() {
    ...
    m_pSteamGameServerNetworking = m_pSteamClient->GetISteamNetworking(hSteamUser, hSteamPipe,
                                                                       STEAMNETWORKING_INTERFACE_VERSION);
    if (!m_pSteamGameServerNetworking)
        return false;

    m_pSteamGameServerStats = m_pSteamClient->GetISteamGameServerStats(hSteamUser, hSteamPipe,
