...
static inline bool BIsOculusHMD(EVRHMDType eType) {
    return eType == k_eEVRHMDType_Oculus_DK1 || eType == k_eEVRHMDType_Oculus_DK2 ||
           eType == k_eEVRHMDType_Oculus_Rift || eType == k_eEVRHMDType_Oculus_Unknown;
}
...
public:
    ...
    static const char *
    Render(uint64 ulSteamID);    // static method to render a uint64 representation of a steam ID to a string
...
public:
    ...
    static const char *
    Render(uint64 ulGameID);        // static method to render a uint64 representation of a Game ID to a string
